...
#'
#' @param Y input data. A \code{n x p} data matrix; \code{n} observations and \code{p} variables.
...
#'
#' @param madcoef scaled MAD, a coefficient which is used to scale MAD to a robust estimate
...
#'
#' @param robscale how to compute dispersion. Specifies the statistical indexes to use to
...
#'   }
#'
#' @param rf  specifies the confidence level of the robust bivariate ellipses, \code{0 < rf < 1}.
...
#'
#' @return an \code{n x 4} matrix, with four columns which contains details about the univariate and
