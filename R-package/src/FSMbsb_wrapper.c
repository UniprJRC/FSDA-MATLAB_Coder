                    ...
                    bool nocheck, emxArray_real_T *Un, emxArray_real_T *BB)
{
  ...
  b_bsbsteps_data = r3->data;
  loop_ub = irank * 10;
  for (i = 0; i < loop_ub; i++) {
    b_bsbsteps_data[i] = rtNaN;
  }
  emxInit_real_T(&r4, 2);
  cat(Szi, r3, r4);
  b_bsbsteps_data = r4->data;
        ...
        if (b_mm - (double)lunit > (double)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            if (mi->size[1] == mibsbr->size[1]) {
              ...
              b_bsbsteps_data = zi->data;
              loop_ub = mi->size[1];
              for (i = 0; i < loop_ub; i++) {
                b_bsbsteps_data[i] = ksor * (mi_data[i] - mibsbr_data[i]);
              }
            } else {
            ...
            loop_ub = zi->size[1];
            for (i = 0; i < loop_ub; i++) {
              ksor += b_bsbsteps_data[i] * Szi_data[i];
            }
            i = r->size[0] * r->size[1];
            r->size[0] = Szi->size[0];
            r->size[1] = Szi->size[0];
            emxEnsureCapacity_real_T(r, i);
            b_bsbsteps_data = r->data;
            loop_ub = Szi->size[0];
            i = Yb->size[0] * Yb->size[1];
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                ...
                b_bsbsteps_data[partialTrueCount + r->size[0] * i] = d;
              ...
              for (b_i = 0; b_i < i; b_i++) {
                ...
                if (b_Y->size[1] == mi->size[1]) {
                  ...
                  for (partialTrueCount = 0; partialTrueCount < loop_ub;
                       partialTrueCount++) {
                    b_bsbsteps_data[partialTrueCount] =
                ...
                for (partialTrueCount = 0; partialTrueCount < loop_ub;
                     partialTrueCount++) {
                  ksor += b_bsbsteps_data[partialTrueCount] *
                ...
                for (partialTrueCount = 0; partialTrueCount < loop_ub;
                  ...
                  for (nwhile = 0; nwhile < b_loop_ub; nwhile++) {
                    ...
                    b_bsbsteps_data[nwhile + r->size[0] * partialTrueCount] = d;
          ...
          if (n < 30000) {
            ...
            if ((r->size[0] == Ym->size[0]) && (r->size[1] == Ym->size[1])) {
              ...
              for (i = 0; i < loop_ub; i++) {
                S_data[i] = b_bsbsteps_data[i] * Ym_data[i];
              }
              sum(Yb, MD);
              S_data = MD->data;
            } else {
          ...
          if (b_mm > percn) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                   partialTrueCount++) {
                b_bsbsteps_data[partialTrueCount + b_Ym->size[0] * i] =
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                   partialTrueCount++) {
                b_bsbsteps_data[partialTrueCount + b_Ym->size[0] * i] = Ym_data
          ...
          if (nwhile > 0) {
            ...
            loop_ub = r->size[0] * r->size[1];
            for (i = 0; i < loop_ub; i++) {
              ksor = b_bsbsteps_data[i];
              b_bsbsteps_data[i] = ksor * ksor;
            }
            sum(r, MD);
            S_data = MD->data;
            loop_ub = MD->size[0];
