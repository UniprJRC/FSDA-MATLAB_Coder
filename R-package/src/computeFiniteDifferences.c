...
bool computeFiniteDifferences(i_struct_T *obj,
                              ...
                              int ldJE)
{
  b_captured_var *m_t2_nonlin_workspace_fun_works;
  c_captured_var *h_t2_nonlin_workspace_fun_works;
  c_captured_var *i_t2_nonlin_workspace_fun_works;
  c_captured_var *k_t2_nonlin_workspace_fun_works;
  c_captured_var *n_t2_nonlin_workspace_fun_works;
  c_captured_var *p_t2_nonlin_workspace_fun_works;
  captured_var *e_t2_nonlin_workspace_fun_works;
  captured_var *f_t2_nonlin_workspace_fun_works;
  captured_var *g_t2_nonlin_workspace_fun_works;
  captured_var *j_t2_nonlin_workspace_fun_works;
  captured_var *l_t2_nonlin_workspace_fun_works;
  ...
  if (obj->isEmptyNonlcon) {
    ...
    case 0:
      ...
      while ((!exitg2) && (idx <= obj->nVar - 1)) {
        ...
        i = c_t2_nonlin_workspace_fun_works->size[0] *
            c_t2_nonlin_workspace_fun_works->size[1];
        c_t2_nonlin_workspace_fun_works->size[0] =
        ...
        evalOK = finDiffEvalAndChkErr(
            ...
            k_t2_nonlin_workspace_fun_works, l_t2_nonlin_workspace_fun_works,
