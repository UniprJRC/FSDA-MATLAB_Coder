...
{
  emxFreeMatrix_cell_wrap_58(pStruct->descrs);
  emxFreeMatrix_cell_wrap_58(pStruct->units);
}
...
{
  emxInitMatrix_cell_wrap_58(pStruct->descrs);
  emxInitMatrix_cell_wrap_58(pStruct->units);
}
...
void emxEnsureCapacity_cell_wrap_45(emxArray_cell_wrap_45 *emxArray,
                                    int oldNumel)
{
  int i;
  int newNumel;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = calloc((unsigned int)i, sizeof(cell_wrap_45));
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data, sizeof(cell_wrap_45) * oldNumel);
      if (emxArray->canFreeData) {
        free(emxArray->data);
      }
    }
    emxArray->data = (cell_wrap_45 *)newData;
    emxArray->allocatedSize = i;
    emxArray->canFreeData = true;
  }
  if (oldNumel > newNumel) {
    emxTrim_cell_wrap_45(emxArray, newNumel, oldNumel);
  } else if (oldNumel < newNumel) {
    emxExpand_cell_wrap_45(emxArray, oldNumel, newNumel);
  }
}
...
void emxExpand_cell_wrap_45(emxArray_cell_wrap_45 *emxArray, int fromIndex,
                            int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_45(&emxArray->data[i]);
  }
}

void emxFreeMatrix_cell_wrap_58(cell_wrap_58 pMatrix[4])
{
  int i;
  for (i = 0; i < 4; i++) {
    emxFreeStruct_cell_wrap_58(&pMatrix[i]);
  }
}
...
void emxFreeStruct_cell_wrap_45(cell_wrap_45 *pStruct)
{
  emxFree_real_T(&pStruct->f1);
}

void emxFreeStruct_cell_wrap_58(cell_wrap_58 *pStruct)
{
...
void emxFreeStruct_struct_FSRfan_T(struct_FSRfan_T *pStruct)
{
  ...
  emxFree_cell_wrap_45(&pStruct->Un);
...
void emxFreeStruct_struct_addt_T(struct_addt_T *pStruct)
{
  emxFree_real_T(&pStruct->S2add);
  emxFree_real_T(&pStruct->Tadd);
  emxFree_real_T(&pStruct->pval);
}
...
void emxFree_cell_wrap_45(emxArray_cell_wrap_45 **pEmxArray)
{
  int i;
  int numEl;
  if (*pEmxArray != (emxArray_cell_wrap_45 *)NULL) {
    if ((*pEmxArray)->data != (cell_wrap_45 *)NULL) {
      numEl = 1;
      for (i = 0; i < (*pEmxArray)->numDimensions; i++) {
        numEl *= (*pEmxArray)->size[i];
      }
      for (i = 0; i < numEl; i++) {
        emxFreeStruct_cell_wrap_45(&(*pEmxArray)->data[i]);
      }
    ...
    free((*pEmxArray)->size);
    free(*pEmxArray);
    *pEmxArray = (emxArray_cell_wrap_45 *)NULL;
  }
}
...
void emxInitMatrix_cell_wrap_58(cell_wrap_58 pMatrix[4])
{
  int i;
  for (i = 0; i < 4; i++) {
    emxInitStruct_cell_wrap_58(&pMatrix[i]);
  }
}
...
void emxInitStruct_cell_wrap_45(cell_wrap_45 *pStruct)
{
  emxInit_real_T(&pStruct->f1, 2);
}

void emxInitStruct_cell_wrap_58(cell_wrap_58 *pStruct)
{
...
void emxInitStruct_struct_FSRfan_T(struct_FSRfan_T *pStruct)
{
  ...
  emxInit_cell_wrap_45(&pStruct->Un, 1);
...
void emxInitStruct_struct_addt_T(struct_addt_T *pStruct)
{
  pStruct->b.size[0] = 0;
  emxInit_real_T(&pStruct->S2add, 2);
  emxInit_real_T(&pStruct->Tadd, 2);
  emxInit_real_T(&pStruct->pval, 2);
}
...
void emxInit_cell_wrap_45(emxArray_cell_wrap_45 **pEmxArray, int numDimensions)
{
  emxArray_cell_wrap_45 *emxArray;
  int i;
  *pEmxArray = (emxArray_cell_wrap_45 *)malloc(sizeof(emxArray_cell_wrap_45));
  emxArray = *pEmxArray;
  emxArray->data = (cell_wrap_45 *)NULL;
  emxArray->numDimensions = numDimensions;
  emxArray->size = (int *)malloc(sizeof(int) * numDimensions);
  emxArray->allocatedSize = 0;
  emxArray->canFreeData = true;
...
void emxTrim_cell_wrap_45(emxArray_cell_wrap_45 *emxArray, int fromIndex,
                          int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
    emxFreeStruct_cell_wrap_45(&emxArray->data[i]);
  }
}
