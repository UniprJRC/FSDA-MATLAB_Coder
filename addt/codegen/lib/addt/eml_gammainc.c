  ...
  if (!(x > 0.0)) {
    ...
    if (x > 1.0E+6) {
      ...
      if (t < 15.0) {
        ...
        a1 = 0.5 * ((((((((((((((((((((((0.0012710976495261409 * (asq - 0.5) +
          ...
          0.5) + -0.0838864557023002) * (asq - 0.5) + -0.11946395996432542) *
                    ...
                    0.27537474159737679) * asq * exp(-dj * dj) *
      ...
      if (x < a - 1.0) {
        ...
        asq = a * (((a1 / old + dj / x) + vsq / (x * old)) + asq / (x * x));
        if (logpax < 709.782712893384) {
          logpax = exp(logpax) * asq;
        } else {
          logpax = exp(logpax + log(asq));
        }
      ...
      do {
        ...
        if (n <= d) {
          t = (a - n) * t / x;
          if (fabs(t) < 2.2204460492503131E-16) {
            exitg1 = 1;
          } else {
            n++;
          }
      ...
      if (n <= d) {
        ...
        if (dj == 0.0) {
          ...
          asq = t;
          stirlerr = 0.0;
          while (fabs(asq - stirlerr) > 2.2204460492503131E-16 * asq) {
            stirlerr = asq;
            asq = n - dj;
            vsq = (a1 + vsq * asq) * t;
            xD0 = (old + xD0 * asq) * t;
