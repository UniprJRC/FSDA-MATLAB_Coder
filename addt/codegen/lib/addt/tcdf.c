        ...
        if (v < xsq) {
          ...
          if ((0.0 < x) && (x < 1.0)) {
            ...
            if (x < 1.5 / ((term + 0.5) + 2.0)) {
              xsq = 1.0 - exp(((0.5 * logx + term * log1mx) -
                               -0.69314718055994529) - xsq) * betainc_cf(x, 0.5,
                term);
            } else {
            ...
            if (!(xsq == xsq)) {
              ...
              if (((term + 0.5) - 1.0) * (1.0 - x) > 0.8) {
                x = 0.70710678118654746 * (3.0 * ((1.0 - 1.0 / (9.0 * term)) *
                  xsq - 0.77777777777777779 * logx) / sqrt(xsq * xsq / term +
                  logx * logx / 0.5));
                t = 3.97886080735226 / (fabs(x) + 3.97886080735226);
                xsq = 0.5 * ((((((((((((((((((((((0.0012710976495261409 * (t -
                  0.5) + 0.00011931402283834095) * (t - 0.5) +
                ...
                logx = term;
                gammaln(&logx);
                xsq = eml_gammainc(0.5 * (((term + 0.5) - 1.0) * (3.0 - x) -
                  (term - 1.0)) * (1.0 - x), term, log(term), logx);
              }
            }
          } else if (x == 0.0) {
            xsq = 1.0;
