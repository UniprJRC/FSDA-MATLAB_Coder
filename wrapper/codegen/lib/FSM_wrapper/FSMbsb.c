    ...
    while (Ra && (nwhile < 100)) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
             partialTrueCount++) {
          b_Y->data[partialTrueCount + b_Y->size[0] * i] =
              Y->data[((int)bsb->data[partialTrueCount] + Y->size[0] * i) - 1];
        }
      }
      cov(b_Y, Yb);
      irank = local_rank(Yb);
        ...
        if (b_mm <= percn) {
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
              ...
              Yb->data[partialTrueCount + Yb->size[0] * i] =
                  Y->data[((int)bsb->data[partialTrueCount] + Y->size[0] * i) -
                          1];
            }
          }
        } else {
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                 partialTrueCount++) {
              Yb->data[partialTrueCount + Yb->size[0] * i] =
                  Y->data[(r3->data[partialTrueCount] + Y->size[0] * i) - 1];
            }
          }
        }
        ...
        if (b_mm >= init1) {
          ...
          if (ifWhileCond(&c_data)) {
            if (b_mm <= percn) {
              ...
              loop_ub = r4->size[0];
              for (i = 0; i < loop_ub; i++) {
                BB->data[(r4->data[i] + BB->size[0] * ((int)ij - 1)) - 1] =
        ...
        if (b_mm - (double)lunit > (double)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                   partialTrueCount++) {
                b_Y->data[partialTrueCount + b_Y->size[0] * i] =
                    Y->data[((int)unitout->data[partialTrueCount] +
                             Y->size[0] * i) -
                            1];
              }
            }
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                     partialTrueCount++) {
                  b_Y->data[partialTrueCount + b_Y->size[0] * i] =
                      Y->data[(r8->data[partialTrueCount] + Y->size[0] * i) -
                              1];
                }
              }
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                     partialTrueCount++) {
                  b_Y->data[partialTrueCount + b_Y->size[0] * i] =
                      Y->data[((int)bsbr->data[partialTrueCount] +
                               Y->size[0] * i) -
                              1];
                }
              }
            ...
            if ((S->size[0] == 0) || (S->size[1] == 0) || (zi->size[1] == 0)) {
              ...
              cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                          (MKL_INT)S->size[0], (MKL_INT)1, (MKL_INT)S->size[1],
                          1.0, &S->data[0], (MKL_INT)S->size[0], &zi->data[0],
            ...
            if (unitout->size[0] > 1) {
              ...
              for (b_i = 0; b_i < i; b_i++) {
                ...
                if ((S->size[0] == 0) || (S->size[1] == 0) ||
                  ...
                  Szi->size[0] = S->size[0];
                  emxEnsureCapacity_real_T(Szi, partialTrueCount);
                  for (partialTrueCount = 0; partialTrueCount < loop_ub;
                       partialTrueCount++) {
                    Szi->data[partialTrueCount] = 0.0;
                  }
                } else {
                  partialTrueCount = Szi->size[0];
                  Szi->size[0] = S->size[0];
                  emxEnsureCapacity_real_T(Szi, partialTrueCount);
                  cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                              (MKL_INT)S->size[0], (MKL_INT)1,
                              (MKL_INT)S->size[1], 1.0, &S->data[0],
                              (MKL_INT)S->size[0], &zi->data[0], (MKL_INT)1,
                              0.0, &Szi->data[0], (MKL_INT)S->size[0]);
                }
                /*  S=S+(S*(zi')*zi*S)/(1-zi*S*(zi')); */
                if (zi->size[1] < 1) {
                  ksor = 0.0;
                } else {
                  ksor = cblas_ddot((MKL_INT)zi->size[1], &zi->data[0],
                                    (MKL_INT)1, &Szi->data[0], (MKL_INT)1);
                }
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                 partialTrueCount++) {
              b_Y->data[partialTrueCount + b_Y->size[0] * i] =
                  Y->data[((int)unit->data[partialTrueCount] + Y->size[0] * i) -
                          1];
            }
          }
          combineVectorElements(b_Y, mi);
            ...
            for (b_i = 0; b_i < lunit; b_i++) {
              ...
              if ((S->size[0] == 0) || (S->size[1] == 0) ||
                ...
                cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                            (MKL_INT)S->size[0], (MKL_INT)1,
                            (MKL_INT)S->size[1], 1.0, &S->data[0],
                            (MKL_INT)S->size[0], &zi->data[0], (MKL_INT)1, 0.0,
                            &Szi->data[0], (MKL_INT)S->size[0]);
              }
              /*  S=S-(S*(zi')*zi*S)/(1+zi*S*(zi')); */
              if (zi->size[1] < 1) {
                ksor = 0.0;
          ...
          if (b_mm > percn) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                ...
                b_Ym->data[partialTrueCount + b_Ym->size[0] * i] =
                    Ym->data[(r5->data[partialTrueCount] + Ym->size[0] * i) -
                             1];
              }
              b_loop_ub = r6->size[0];
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                   partialTrueCount++) {
                b_Y->data[partialTrueCount + b_Y->size[0] * i] =
                    Ym->data[(r6->data[partialTrueCount] + Ym->size[0] * i) -
                             1];
              }
            }
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                   partialTrueCount++) {
                b_Ym->data[partialTrueCount + b_Ym->size[0] * i] =
                    Ym->data[((int)bsb->data[partialTrueCount] +
                              Ym->size[0] * i) -
                             1];
              }
              b_loop_ub = bsb->size[0];
