    ...
    while (Ra && (nwhile < 100)) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
             partialTrueCount++) {
          c_Y->data[partialTrueCount + c_Y->size[0] * i] =
        ...
        if (b_mm <= percn) {
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                 partialTrueCount++) {
              Yb->data[partialTrueCount + Yb->size[0] * i] =
                  b_Y->data[(r4->data[partialTrueCount] + b_Y->size[0] * i) -
                            1];
            }
          }
        }
        ...
        if (b_mm >= init1) {
          ...
          if (ifWhileCond(&c_data)) {
            if (b_mm <= percn) {
              ...
              loop_ub = r5->size[0];
              for (i = 0; i < loop_ub; i++) {
                BB->data[(r5->data[i] + BB->size[0] * ((int)ij - 1)) - 1] =
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                     partialTrueCount++) {
                  c_Y->data[partialTrueCount + c_Y->size[0] * i] =
                      b_Y->data[(r9->data[partialTrueCount] +
                                 b_Y->size[0] * i) -
                                1];
                }
              }
              combineVectorElements(c_Y, mibsbr);
          ...
          if (b_mm < n) {
            ...
            if (rankgap == 1.0) {
              ...
              if (nwhile == (int)b_mm + 1) {
                ...
                i = b_bsb->size[0];
                b_bsb->size[0] = r10->size[0] + loop_ub;
                emxEnsureCapacity_real_T(b_bsb, i);
                b_loop_ub = r10->size[0];
                for (i = 0; i < b_loop_ub; i++) {
                  b_bsb->data[i] = seq->data[r10->data[i] - 1];
                }
                for (i = 0; i < loop_ub; i++) {
                  b_bsb->data[i + r10->size[0]] = seq->data[r11->data[i] - 1];
                }
                i = bsbT->size[0];
                bsbT->size[0] = n;
                emxEnsureCapacity_boolean_T(bsbT, i);
