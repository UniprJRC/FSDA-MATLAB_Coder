            ...
            emxArray_real_T *varargout_1)
{
    ...
    while (Ra && (nwhile < 100)) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        for (end = 0; end < b_loop_ub; end++) {
          b_Y->data[end + b_Y->size[0] * i] = Y->data[((int)bsb->data[end] +
            Y->size[0] * i) - 1];
        }
      }
  ...
  loop_ub = bsb->size[0];
  for (i = 0; i < loop_ub; i++) {
    r->data[i] = (int)bsb->data[i];
  }

  loop_ub = r->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbT->data[r->data[i] - 1] = true;
  }
  ...
  for (i = 0; i < loop_ub; i++) {
    b_loop_ub = bsb->size[0];
    for (end = 0; end < b_loop_ub; end++) {
      b_Y->data[end + b_Y->size[0] * i] = Y->data[((int)bsb->data[end] + Y->
        size[0] * i) - 1];
    }
  }

  irank = local_rank(b_Y);
  emxInit_real_T(&Ym, 2);
  emxInit_real_T(&mi, 2);
      ...
      while ((!exitg1) && (mm <= n - ini0)) {
        ...
        if (b_mm <= percn) {
          ...
          for (i = 0; i < loop_ub; i++) {
            b_loop_ub = r3->size[0];
            for (end = 0; end < b_loop_ub; end++) {
              Yb->data[end + Yb->size[0] * i] = Y->data[(r3->data[end] + Y->
                size[0] * i) - 1];
            }
          }
        }
        ...
        if (b_mm >= init1) {
          ...
          if (c_minimum(Szi) == 0.0) {
            ...
            if (b_mm <= percn) {
              ...
              loop_ub = r4->size[0];
              for (i = 0; i < loop_ub; i++) {
                varargout_1->data[(r4->data[i] + varargout_1->size[0] * ij) - 1]
                  = seq->data[r4->data[i] - 1];
              }
            }
        ...
        if (b_mm - (double)lunit > (double)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (b_i = 0; b_i <= end; b_i++) {
                if (oldbsbT->data[b_i] && MDltminT->data[b_i]) {
                  unitout->data[b_loop_ub] = seq->data[b_i];
                  b_loop_ub++;
                }
              }
            }
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (end = 0; end < b_loop_ub; end++) {
                b_Y->data[end + b_Y->size[0] * i] = Y->data[((int)unitout->
                  data[end] + Y->size[0] * i) - 1];
              }
            }

            combineVectorElements(b_Y, mi);
            i = mi->size[0] * mi->size[1];
            mi->size[0] = 1;
            emxEnsureCapacity_real_T(mi, i);
            loop_ub = mi->size[1] - 1;
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                b_loop_ub = r8->size[0];
                for (end = 0; end < b_loop_ub; end++) {
                  b_Y->data[end + b_Y->size[0] * i] = Y->data[(r8->data[end] +
                    Y->size[0] * i) - 1];
                }
              }

              combineVectorElements(b_Y, mibsbr);
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                for (end = 0; end < b_loop_ub; end++) {
                  b_Y->data[end + b_Y->size[0] * i] = Y->data[((int)bsbr->
                    data[end] + Y->size[0] * i) - 1];
                }
              }
            ...
            if ((S->size[0] == 0) || (S->size[1] == 0) || (zi->size[1] == 0)) {
              i = Szi->size[0];
              Szi->size[0] = S->size[0];
              emxEnsureCapacity_real_T(Szi, i);
              loop_ub = S->size[0];
              ...
              Szi->size[0] = S->size[0];
              emxEnsureCapacity_real_T(Szi, i);
              cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans, (MKL_INT)
                          S->size[0], (MKL_INT)1, (MKL_INT)S->size[1], 1.0,
                          &S->data[0], (MKL_INT)S->size[0], &zi->data[0],
                          (MKL_INT)1, 0.0, &Szi->data[0], (MKL_INT)S->size[0]);
            }
            ...
            if (zi->size[1] < 1) {
              ...
              ksor = cblas_ddot((MKL_INT)zi->size[1], &zi->data[0], (MKL_INT)1,
                                &Szi->data[0], (MKL_INT)1);
            }
            ...
            if (unitout->size[0] > 1) {
              ...
              for (b_i = 0; b_i < i; b_i++) {
                ...
                if ((S->size[0] == 0) || (S->size[1] == 0) || (zi->size[1] == 0))
                {
                  ...
                  Szi->size[0] = S->size[0];
                  emxEnsureCapacity_real_T(Szi, end);
                  for (end = 0; end < loop_ub; end++) {
                    Szi->data[end] = 0.0;
                  }
                } else {
                ...
                if (zi->size[1] < 1) {
                  ...
                  ksor = cblas_ddot((MKL_INT)zi->size[1], &zi->data[0], (MKL_INT)
                                    1, &Szi->data[0], (MKL_INT)1);
                }
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (end = 0; end < b_loop_ub; end++) {
              b_Y->data[end + b_Y->size[0] * i] = Y->data[((int)unit->data[end]
                + Y->size[0] * i) - 1];
            }
          }
          ...
          if ((S->size[0] == 0) || (S->size[1] == 0) || (zi->size[1] == 0)) {
            ...
            cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans, (MKL_INT)
                        S->size[0], (MKL_INT)1, (MKL_INT)S->size[1], 1.0,
                        &S->data[0], (MKL_INT)S->size[0], &zi->data[0], (MKL_INT)
                        1, 0.0, &Szi->data[0], (MKL_INT)S->size[0]);
          }
          ...
          if (b_mm > percn) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              b_loop_ub = r6->size[0];
              for (end = 0; end < b_loop_ub; end++) {
                b_Y->data[end + b_Y->size[0] * i] = Ym->data[(r6->data[end] +
                  Ym->size[0] * i) - 1];
              }
            }

            b_mtimes(b_Ym, b_Y, Yb);
            inv(Yb, S);
            end = bsbT->size[0] - 1;
            trueCount = 0;
            for (b_i = 0; b_i <= end; b_i++) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              b_loop_ub = bsb->size[0];
              for (end = 0; end < b_loop_ub; end++) {
                b_Y->data[end + b_Y->size[0] * i] = Ym->data[((int)bsb->data[end]
                  + Ym->size[0] * i) - 1];
              }
            }
          ...
          if (b_mm < n) {
            ...
            if (rankgap == 1.0) {
              ...
              if (b_mm <= percn) {
                ...
                trueCount = 0;
                for (b_i = 0; b_i <= end; b_i++) {
                  if (MDltminT->data[(int)bsb->data[b_i] - 1]) {
                    trueCount++;
                  }
                }
                ...
                for (b_i = 0; b_i <= end; b_i++) {
                  if (MDltminT->data[(int)bsb->data[b_i] - 1]) {
                    bsbrini->data[b_loop_ub] = (unsigned int)bsb->data[b_i];
                    b_loop_ub++;
                  }
                }
                ...
                for (b_i = 0; b_i <= end; b_i++) {
                  if (!MDltminT->data[(int)bsb->data[b_i] - 1]) {
                    unitout->data[b_loop_ub] = bsb->data[b_i];
                    b_loop_ub++;
                  }
                }

                i = r->size[0];
                r->size[0] = bsbrini->size[0];
                emxEnsureCapacity_int32_T(r, i);
                loop_ub = bsbrini->size[0];
                for (i = 0; i < loop_ub; i++) {
                  r->data[i] = (int)bsbrini->data[i];
                }
              ...
              for (loop_ub = 0; loop_ub < i; loop_ub++) {
                ...
                if (bsbT->data[lunit - 1]) {
                  if (b_mm <= percn) {
                    ...
                    for (b_i = 0; b_i <= end; b_i++) {
                      if ((int)unitout->data[b_i] != lunit) {
                        unitout->data[b_loop_ub] = unitout->data[b_i];
                        b_loop_ub++;
                      }
                    }
              ...
              if (nwhile == (int)b_mm + 1) {
                if (b_mm <= percn) {
                  ...
                  for (b_i = 0; b_i <= end; b_i++) {
                    if (bsbT->data[b_i]) {
                      bsb->data[b_loop_ub] = seq->data[b_i];
                      b_loop_ub++;
                    }
                  }
                }
              ...
              b_eml_find(MDltminT, r);
              i = unit->size[0];
              unit->size[0] = r->size[0];
              emxEnsureCapacity_real_T(unit, i);
              loop_ub = r->size[0];
              for (i = 0; i < loop_ub; i++) {
                unit->data[i] = r->data[i];
              }
            }
        ...
        if (b_mm - (double)lunit > (double)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                b_loop_ub = r7->size[0];
                for (end = 0; end < b_loop_ub; end++) {
                  b_Y->data[end + b_Y->size[0] * i] = Y->data[(r7->data[end] +
                    Y->size[0] * i) - 1];
                }
              }
          ...
          if (b_mm > percn) {
            ...
            for (i = 0; i < loop_ub; i++) {
              b_loop_ub = r4->size[0];
              for (end = 0; end < b_loop_ub; end++) {
                b_Ym->data[end + b_Ym->size[0] * i] = Ym->data[(r4->data[end] +
                  Ym->size[0] * i) - 1];
              }

              b_loop_ub = r5->size[0];
              for (end = 0; end < b_loop_ub; end++) {
                b_Y->data[end + b_Y->size[0] * i] = Ym->data[(r5->data[end] +
                  Ym->size[0] * i) - 1];
              }
            }
        ...
        if (b_mm >= init1) {
          ...
          if (c_minimum(Szi) == 0.0) {
            ...
            if (b_mm <= percn) {
              ...
              loop_ub = r4->size[0];
              for (i = 0; i < loop_ub; i++) {
                varargout_1->data[(r4->data[i] + varargout_1->size[0] * ((int)ij
                  - 1)) - 1] = seq->data[r4->data[i] - 1];
              }
            }
