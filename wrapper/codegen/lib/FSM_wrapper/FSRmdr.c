            ...
            emxArray_real_T *Bols, emxArray_real_T *S2)
{
  ...
  for (mm = 0; mm <= i; mm++) {
    ...
    /*  rank is ok */
    mldivide(Xb, yb, b);
    if ((Xb->size[0] == 0) || (Xb->size[1] == 0) || (b->size[0] == 0)) {
      i1 = resBSB->size[0];
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                  (MKL_INT)Xb->size[0], (MKL_INT)1, (MKL_INT)Xb->size[1], 1.0,
                  &Xb->data[0], (MKL_INT)Xb->size[0], &b->data[0],
                  (MKL_INT)b->size[0], 0.0, &resBSB->data[0],
                  (MKL_INT)Xb->size[0]);
    }
    i1 = resBSB->size[0];
    ...
    if ((X->size[0] == 0) || (X->size[1] == 0) || (b->size[0] == 0)) {
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                  ...
                  (MKL_INT)b->size[0], 0.0, &e->data[0], (MKL_INT)X->size[0]);
    }
    loop_ub = y->size[0];
    i1 = e->size[0];
    e->size[0] = y->size[0];
    ...
    if (b_mm >= init1) {
      ...
      if (resBSB->size[0] < 1) {
        ...
        y_tmp = cblas_ddot((MKL_INT)resBSB->size[0], &resBSB->data[0],
                           (MKL_INT)1, &resBSB->data[0], (MKL_INT)1);
      }
      S2->data[i2 + S2->size[0]] = y_tmp / (double)((int)b_mm - p);
      /*  Store R2 */
      ...
      if (b->size[0] < 1) {
        ...
        thpmm_data = cblas_ddot((MKL_INT)b->size[0], &b->data[0], (MKL_INT)1,
                                &b->data[0], (MKL_INT)1);
      }
      S2->data[i2 + S2->size[0] * 2] = 1.0 - y_tmp / thpmm_data;
      if ((int)b_mm < n) {
        b_mtimes(Xb, Xb, mAm);
        ...
        mAm->size[0] = r3->size[0];
        mAm->size[1] = r3->size[1];
        emxEnsureCapacity_real_T(mAm, i1);
        loop_ub = r3->size[0] * r3->size[1];
        for (i1 = 0; i1 < loop_ub; i1++) {
          mAm->data[i1] = r3->data[i1] * Xncl->data[i1];
        }
        sum(mAm, b);
        /* hiall=sum((X/mAm).*X,2); */
        if (Ra) {
