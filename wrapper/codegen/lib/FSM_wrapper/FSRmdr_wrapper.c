      ...
      if (mm <= (int)(n + (1.0 - (double)ini0)) - 1) {
        ...
        if (Ra) {
          ...
          if ((Xb->size[0] == 0) || (Xb->size[1] == 0) ||
            ...
            cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                        (MKL_INT)Xb->size[0], (MKL_INT)1, (MKL_INT)Xb->size[1],
                        1.0, &Xb->data[0], (MKL_INT)Xb->size[0],
                        &blast->data[0], (MKL_INT)blast->size[0], 0.0,
                        &resBSB->data[0], (MKL_INT)Xb->size[0]);
          }
          i = resBSB->size[0];
        ...
        if (guard2) {
          if ((b_X->size[0] == 0) || (b_X->size[1] == 0) ||
            ...
            emxEnsureCapacity_real_T(e, i);
            cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                        (MKL_INT)b_X->size[0], (MKL_INT)1,
                        (MKL_INT)b_X->size[1], 1.0, &b_X->data[0],
                        (MKL_INT)b_X->size[0], &blast->data[0],
                        (MKL_INT)blast->size[0], 0.0, &e->data[0],
                        (MKL_INT)b_X->size[0]);
          }
          i = e->size[0];
          e->size[0] = b_y->size[0];
          ...
          if (b_mm >= init1) {
            ...
            if (Ra) {
              ...
              if (resBSB->size[0] < 1) {
                ...
                b = cblas_ddot((MKL_INT)resBSB->size[0], &resBSB->data[0],
                               (MKL_INT)1, &resBSB->data[0], (MKL_INT)1);
              }
              S2->data[i1 + S2->size[0]] = b / (b_mm - p);
              /*  Store R2 */
              ...
              if (bsbx->size[0] < 1) {
                ...
                initdef = cblas_ddot((MKL_INT)bsbx->size[0], &bsbx->data[0],
                                     (MKL_INT)1, &bsbx->data[0], (MKL_INT)1);
              }
              S2->data[i1 + S2->size[0] * 2] = 1.0 - b / initdef;
              if (b_mm < n) {
                b_mtimes(Xb, Xb, b_bsbsteps);
                ...
                for (i = 0; i < loop_ub; i++) {
                  ...
                  for (trueCount = 0; trueCount < irank; trueCount++) {
                    Xncl->data[trueCount + Xncl->size[0] * i] =
                ...
                mrdiv(Xncl, b_bsbsteps, r4);
                i = b_bsbsteps->size[0] * b_bsbsteps->size[1];
                b_bsbsteps->size[0] = r4->size[0];
                b_bsbsteps->size[1] = r4->size[1];
                emxEnsureCapacity_real_T(b_bsbsteps, i);
                loop_ub = r4->size[0] * r4->size[1];
                for (i = 0; i < loop_ub; i++) {
                  b_bsbsteps->data[i] = r4->data[i] * Xncl->data[i];
                }
                sum(b_bsbsteps, bsbx);
                /* hiall=sum((X/mAm).*X,2); */
                if (bonflevout) {
