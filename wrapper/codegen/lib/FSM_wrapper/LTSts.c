          ...
          double *exitflag)
{
  ...
  while ((!exitg1) &&
    ...
    i = B->size[0] * B->size[1];
    B->size[0] = 1;
    B->size[1] = indlinsc->contents->size[1];
    emxEnsureCapacity_real_T(B, i);
    loop_ub = indlinsc->contents->size[1];
    for (i = 0; i < loop_ub; i++) {
      B->data[i] = newbeta->data[(int)indlinsc->contents->data[i] - 1];
    }
    ...
    if ((a->size[0] == 0) || (a->size[1] == 0) ||
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans, (MKL_INT)a->size[0],
                  (MKL_INT)1, (MKL_INT)a->size[1], 1.0, &a->data[0],
                  (MKL_INT)a->size[0], &B->data[0], (MKL_INT)1, 0.0,
                  &at->data[0], (MKL_INT)a->size[0]);
    }
    ...
    if (isemptyX->contents) {
      if (lshiftYN->contents == 1.0) {
        ...
        for (i2 = 0; i2 < loop_ub; i2++) {
          ...
          for (result = 0; result < input_sizes_idx_1; result++) {
            varargin_1->data[result + varargin_1->size[0] * i2] =
                Xtrend->contents->data[((int)bsb->contents->data[result] +
        ...
        c_bsxfun(at, tr_expl_nls_lshift, varargin_2);
      ...
      for (i2 = 0; i2 < loop_ub; i2++) {
        input_sizes_idx_1 = bsb->contents->size[0];
        for (result = 0; result < input_sizes_idx_1; result++) {
          varargin_2->data[result + varargin_2->size[0] * i2] =
              X->contents->data[((int)bsb->contents->data[result] +
      ...
      c_bsxfun(at, tr_expl_nls_lshift, a);
    ...
    b_input_sizes_idx_1 = yhatnlseaso->size[0];
    yhatnlseaso->size[0] = bsb->contents->size[0];
    emxEnsureCapacity_real_T(yhatnlseaso, b_input_sizes_idx_1);
    loop_ub = bsb->contents->size[0];
    for (b_input_sizes_idx_1 = 0; b_input_sizes_idx_1 < loop_ub;
         b_input_sizes_idx_1++) {
      yhatnlseaso->data[b_input_sizes_idx_1] =
          Seq->contents
              ->data[(int)bsb->contents->data[b_input_sizes_idx_1] - 1];
    }
    b_input_sizes_idx_1 = a->size[0] * a->size[1];
    a->size[0] = bsb->contents->size[0];
    loop_ub = i1 - i;
    a->size[1] = loop_ub;
    emxEnsureCapacity_real_T(a, b_input_sizes_idx_1);
    for (i1 = 0; i1 < loop_ub; i1++) {
      input_sizes_idx_1 = bsb->contents->size[0];
      for (b_input_sizes_idx_1 = 0; b_input_sizes_idx_1 < input_sizes_idx_1;
           b_input_sizes_idx_1++) {
        a->data[b_input_sizes_idx_1 + a->size[0] * i1] =
            Seq->contents->data[((int)bsb->contents->data[b_input_sizes_idx_1] +
                                 Seq->contents->size[0] * (i + i1)) -
                                1];
      }
    }
    ...
    emxEnsureCapacity_real_T(B, i);
    for (i = 0; i < loop_ub; i++) {
      B->data[i] = b0145->data[(i2 + i) + 1];
    }
    if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
      i = r->size[0];
      r->size[0] = a->size[0];
      emxEnsureCapacity_real_T(r, i);
      loop_ub = a->size[0];
    ...
    if (isemptyX->contents) {
      if (lshiftYN->contents == 1.0) {
        ...
        if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
          ...
          cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                      (MKL_INT)a->size[0], (MKL_INT)1, (MKL_INT)a->size[1], 1.0,
                      &a->data[0], (MKL_INT)a->size[0], &B->data[0], (MKL_INT)1,
                      0.0, &at->data[0], (MKL_INT)a->size[0]);
        }
        i = b_a->size[0];
        ...
        c_bsxfun(yhatnlseaso, tr_expl_nls_lshift, a);
        mldivide(a, r, yhatnlseaso);
      } else {
        betadiff = trend->contents + 1.0;
        if (1.0 > betadiff) {
          loop_ub = 0;
      ...
      if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
        ...
        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                    (MKL_INT)a->size[0], (MKL_INT)1, (MKL_INT)a->size[1], 1.0,
                    &a->data[0], (MKL_INT)a->size[0], &B->data[0], (MKL_INT)1,
                    0.0, &r1->data[0], (MKL_INT)a->size[0]);
      }
      i = b_a->size[0];
      b_a->size[0] = bsb->contents->size[0];
      emxEnsureCapacity_real_T(b_a, i);
      loop_ub = bsb->contents->size[0];
      for (i = 0; i < loop_ub; i++) {
        b_a->data[i] = Xlshift->contents->data[(int)bsb->contents->data[i] - 1];
      }
      loop_ub = Xseaso->contents->size[1];
      i = tr_expl_nls_lshift->size[0] * tr_expl_nls_lshift->size[1];
      tr_expl_nls_lshift->size[0] = bsb->contents->size[0];
    ...
    loop_ub = indlinsc->contents->size[1];
    for (i = 0; i < loop_ub; i++) {
      r2->data[i] = (int)indlinsc->contents->data[i];
    }
    loop_ub = r2->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    for (i = 0; i < loop_ub; i++) {
      r2->data[i] = (int)otherind->contents->data[i];
    }
    loop_ub = r2->size[1];
    for (i = 0; i < loop_ub; i++) {
                  ...
                  emxArray_real_T *newbeta, double *exitflag)
{
  ...
  while ((!exitg1) &&
    ...
    /*  at= yhatseaso = fitted values for linear part of seasonal */
    /*  component */
    if ((Xseasobsb->size[0] == 0) || (Xseasobsb->size[1] == 0) ||
        (indlinsc->contents->size[1] == 0)) {
      i = Xlshiftbsb->size[0];
      Xlshiftbsb->size[0] = Xseasobsb->size[0];
      emxEnsureCapacity_real_T(Xlshiftbsb, i);
      sizes_idx_1 = Xseasobsb->size[0];
      for (i = 0; i < sizes_idx_1; i++) {
        Xlshiftbsb->data[i] = 0.0;
      }
    } else {
      i = Xlshiftbsb->size[0];
      Xlshiftbsb->size[0] = Xseasobsb->size[0];
      emxEnsureCapacity_real_T(Xlshiftbsb, i);
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                  (MKL_INT)Xseasobsb->size[0], (MKL_INT)1,
                  (MKL_INT)Xseasobsb->size[1], 1.0, &Xseasobsb->data[0],
                  (MKL_INT)Xseasobsb->size[0], &y->data[0], (MKL_INT)1, 0.0,
                  &Xlshiftbsb->data[0], (MKL_INT)Xseasobsb->size[0]);
    }
    /*  OLS to estimate coefficients of trend + expl variables + non lin coeff
     * of */
    /*  seasonal + coefficient of fixed level shift */
    ...
    if ((Seqbsbvarampl->size[0] == 0) || (Seqbsbvarampl->size[1] == 0) ||
        (indnlseaso->size[1] == 0)) {
      i = b_Seqbsb->size[0];
      b_Seqbsb->size[0] = Seqbsbvarampl->size[0];
      emxEnsureCapacity_real_T(b_Seqbsb, i);
      sizes_idx_1 = Seqbsbvarampl->size[0];
      for (i = 0; i < sizes_idx_1; i++) {
        b_Seqbsb->data[i] = 0.0;
      }
    } else {
      ...
      emxEnsureCapacity_real_T(b_Seqbsb, i);
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                  (MKL_INT)Seqbsbvarampl->size[0], (MKL_INT)1,
                  (MKL_INT)Seqbsbvarampl->size[1], 1.0, &Seqbsbvarampl->data[0],
                  (MKL_INT)Seqbsbvarampl->size[0], &y->data[0], (MKL_INT)1, 0.0,
                  &b_Seqbsb->data[0], (MKL_INT)Seqbsbvarampl->size[0]);
    }
    i = y->size[0] * y->size[1];
    y->size[0] = 1;
    ...
    if ((Xtrendbsb->size[0] == 0) || (Xtrendbsb->size[1] == 0) ||
        (indnlseasoc->size[1] == 0)) {
      i = b_Xlshiftbsb->size[0];
      b_Xlshiftbsb->size[0] = Xtrendbsb->size[0];
      emxEnsureCapacity_real_T(b_Xlshiftbsb, i);
      sizes_idx_1 = Xtrendbsb->size[0];
      for (i = 0; i < sizes_idx_1; i++) {
        b_Xlshiftbsb->data[i] = 0.0;
      }
    } else {
      i = b_Xlshiftbsb->size[0];
      b_Xlshiftbsb->size[0] = Xtrendbsb->size[0];
      emxEnsureCapacity_real_T(b_Xlshiftbsb, i);
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                  (MKL_INT)Xtrendbsb->size[0], (MKL_INT)1,
                  (MKL_INT)Xtrendbsb->size[1], 1.0, &Xtrendbsb->data[0],
                  (MKL_INT)Xtrendbsb->size[0], &y->data[0], (MKL_INT)1, 0.0,
                  &b_Xlshiftbsb->data[0], (MKL_INT)Xtrendbsb->size[0]);
    }
    i = b_Seqbsb->size[0];
    ...
    if ((varampl->contents == 0.0) && (lshiftYN->contents == 0.0)) {
      ...
      if ((Xsel->contents->size[0] == 0) || (Xsel->contents->size[1] == 0) ||
        ...
        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                    (MKL_INT)Xsel->contents->size[0], (MKL_INT)1,
                    (MKL_INT)Xsel->contents->size[1], 1.0,
                    &Xsel->contents->data[0], (MKL_INT)Xsel->contents->size[0],
                    &outIRWLS->betarw->data[0],
                    (MKL_INT)outIRWLS->betarw->size[0], 0.0,
                    &yhat->contents->data[0], (MKL_INT)Xsel->contents->size[0]);
      }
      exitfl = 0.0;
    } else if (lshiftYN->contents == 1.0) {
      if (varampl->contents > 0.0) {
        ...
        if ((Xseld->size[0] == 0) || (Xseld->size[1] == 0) ||
            (newb->size[0] == 0)) {
          i = yhat->contents->size[0];
          yhat->contents->size[0] = Xseld->size[0];
          emxEnsureCapacity_real_T(yhat->contents, i);
          vlen = Xseld->size[0];
          for (i = 0; i < vlen; i++) {
            yhat->contents->data[i] = 0.0;
          ...
          emxEnsureCapacity_real_T(yhat->contents, i);
          cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                      (MKL_INT)Xseld->size[0], (MKL_INT)1,
                      (MKL_INT)Xseld->size[1], 1.0, &Xseld->data[0],
                      (MKL_INT)Xseld->size[0], &newb->data[0],
                      (MKL_INT)newb->size[0], 0.0, &yhat->contents->data[0],
                      (MKL_INT)Xseld->size[0]);
        }
         ...
         d_captured_var *yhat, const emxArray_real_T *beta0)
{
  ...
  if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans, (MKL_INT)a->size[0],
                (MKL_INT)1, (MKL_INT)a->size[1], 1.0, &a->data[0],
                (MKL_INT)a->size[0], &B->data[0], (MKL_INT)1, 0.0,
                &yhattrend->data[0], (MKL_INT)a->size[0]);
  }
  ...
  if (seasonal->contents > 0.0) {
    if (seasonal->contents < s->contents / 2.0) {
      ...
      if ((a->size[0] == 0) || (a->size[1] == 0) || (r->size[1] == 0)) {
        i = yhatX->size[0];
        ...
        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                    (MKL_INT)a->size[0], (MKL_INT)1, (MKL_INT)a->size[1], 1.0,
                    &a->data[0], (MKL_INT)a->size[0], &B->data[0], (MKL_INT)1,
                    0.0, &yhatX->data[0], (MKL_INT)a->size[0]);
      }
      emxFree_uint32_T(&r);
      ...
      a->size[0] = bsb->contents->size[0];
      a->size[1] = loop_ub;
      emxEnsureCapacity_real_T(a, c_loop_ub);
      for (c_loop_ub = 0; c_loop_ub < loop_ub; c_loop_ub++) {
        b_loop_ub = bsb->contents->size[0];
        for (i2 = 0; i2 < b_loop_ub; i2++) {
          a->data[i2 + a->size[0] * c_loop_ub] =
              Xseaso->contents->data[((int)bsb->contents->data[i2] +
                                      Xseaso->contents->size[0] * c_loop_ub) -
                                     1];
        }
      }
      ...
      loop_ub = i1 - i;
      B->size[1] = loop_ub;
      emxEnsureCapacity_real_T(B, c_loop_ub);
      for (i1 = 0; i1 < loop_ub; i1++) {
        B->data[i1] = beta0->data[(i + i1) + 1];
      }
      if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
        i = yhatX->size[0];
        yhatX->size[0] = a->size[0];
    ...
    if (varampl->contents > 0.0) {
      ...
      for (i1 = 0; i1 < loop_ub; i1++) {
        ...
        for (i3 = 0; i3 < b_loop_ub; i3++) {
          a->data[i3 + a->size[0] * i1] =
              Seq->contents->data[((int)bsb->contents->data[i3] +
                                   Seq->contents->size[0] * (i + i1)) -
                                  1];
        }
      }
      i = B->size[0] * B->size[1];
      B->size[0] = 1;
      loop_ub = i2 - c_loop_ub;
      B->size[1] = loop_ub;
      emxEnsureCapacity_real_T(B, i);
      for (i = 0; i < loop_ub; i++) {
        B->data[i] = beta0->data[(c_loop_ub + i) + 1];
      }
      if ((a->size[0] == 0) || (a->size[1] == 0) || (loop_ub == 0)) {
        i = yhatX->size[0];
        yhatX->size[0] = a->size[0];
  ...
  if (isemptyX->contents) {
    ...
    for (c_loop_ub = 0; c_loop_ub < loop_ub; c_loop_ub++) {
      ...
      for (i2 = 0; i2 < b_loop_ub; i2++) {
        a->data[i2 + a->size[0] * c_loop_ub] =
            X->contents->data[((int)bsb->contents->data[i2] +
                               X->contents->size[0] * c_loop_ub) -
                              1];
      }
    }
    c_loop_ub = B->size[0] * B->size[1];
