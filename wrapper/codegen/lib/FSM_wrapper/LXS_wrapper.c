                 ...
                 struct8_T *out, emxArray_real_T *C)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if ((!rtIsNaN(b->data[0])) && (!rtIsInf(b->data[0]))) {
      ...
      if ((out->X->size[0] == 0) || (out->X->size[1] == 0) ||
          (b->size[0] == 0)) {
        i1 = out->residuals->size[0];
        out->residuals->size[0] = out->X->size[0];
        ...
        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                    (MKL_INT)out->X->size[0], (MKL_INT)1,
                    (MKL_INT)out->X->size[1], 1.0, &out->X->data[0],
                    (MKL_INT)out->X->size[0], &b->data[0], (MKL_INT)b->size[0],
                    0.0, &out->residuals->data[0], (MKL_INT)out->X->size[0]);
      }
  ...
  if ((out->X->size[0] == 0) || (out->X->size[1] == 0) ||
    ...
    emxEnsureCapacity_real_T(out->residuals, i);
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                (MKL_INT)out->X->size[0], (MKL_INT)1, (MKL_INT)out->X->size[1],
                1.0, &out->X->data[0], (MKL_INT)out->X->size[0],
                &out->beta->data[0], (MKL_INT)out->beta->size[0], 0.0,
                &out->residuals->data[0], (MKL_INT)out->X->size[0]);
  }
  i = out->residuals->size[0];
  out->residuals->size[0] = b_y->size[0];
  emxEnsureCapacity_real_T(out->residuals, i);
    ...
    if (rew) {
      ...
      if ((out->X->size[0] == 0) || (out->X->size[1] == 0) ||
        ...
        cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                    (MKL_INT)out->X->size[0], (MKL_INT)1,
                    (MKL_INT)out->X->size[1], 1.0, &out->X->data[0],
                    (MKL_INT)out->X->size[0], &out->beta->data[0],
                    (MKL_INT)out->beta->size[0], 0.0, &out->residuals->data[0],
                    (MKL_INT)out->X->size[0]);
      }
      i = out->residuals->size[0];
      out->residuals->size[0] = b_y->size[0];
      emxEnsureCapacity_real_T(out->residuals, i);
