                ...
                int outSC_Score_size[2])
{
  ...
  mldivide(X, vneg, vposlai);
  if ((X->size[0] == 0) || (X->size[1] == 0) || (vposlai->size[0] == 0)) {
    i = znonnegs->size[0];
    znonnegs->size[0] = X->size[0];
    emxEnsureCapacity_real_T(znonnegs, i);
    loop_ub = X->size[0];
    for (i = 0; i < loop_ub; i++) {
      znonnegs->data[i] = 0.0;
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, (MKL_INT)X->size[0],
                ...
                (MKL_INT)X->size[0], &vposlai->data[0],
                (MKL_INT)vposlai->size[0], 0.0, &znonnegs->data[0],
                (MKL_INT)X->size[0]);
  }
  ...
  if (znonnegs->size[0] == 0) {
    ...
    kpos =
        cblas_dnrm2((MKL_INT)znonnegs->size[0], &znonnegs->data[0], (MKL_INT)1);
  }
  q = kpos * kpos;
  ...
  if ((Xw->size[0] == 0) || (Xw->size[1] == 0) || (vposlai->size[0] == 0)) {
    i = znonnegs->size[0];
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, (MKL_INT)Xw->size[0],
                ...
                (MKL_INT)Xw->size[0], &vposlai->data[0],
                (MKL_INT)vposlai->size[0], 0.0, &znonnegs->data[0],
                (MKL_INT)Xw->size[0]);
  }
  /*  Sum of squares of residuals */
  ...
  if (vposboo) {
    ...
    if ((Xw->size[0] == 0) || (Xw->size[1] == 0) || (vposlai->size[0] == 0)) {
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                  (MKL_INT)Xw->size[0], (MKL_INT)1, (MKL_INT)Xw->size[1], 1.0,
                  &Xw->data[0], (MKL_INT)Xw->size[0], &vposlai->data[0],
                  (MKL_INT)vposlai->size[0], 0.0, &znonnegs->data[0],
                  (MKL_INT)Xw->size[0]);
    }
    /*  Sum of squares of residuals */
    ...
    if (znonnegs->size[0] == 0) {
      ...
      kpos = cblas_dnrm2((MKL_INT)znonnegs->size[0], &znonnegs->data[0],
                         (MKL_INT)1);
    }
    kpos *= kpos;
    Glaminus1 = vposlai->data[vposlai->size[0] - 1];
  ...
  if (vposboo && vnegboo) {
    ...
    if ((Xw->size[0] == 0) || (Xw->size[1] == 0) || (vposlai->size[0] == 0)) {
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                  (MKL_INT)Xw->size[0], (MKL_INT)1, (MKL_INT)Xw->size[1], 1.0,
                  &Xw->data[0], (MKL_INT)Xw->size[0], &vposlai->data[0],
                  (MKL_INT)vposlai->size[0], 0.0, &r->data[0],
                  (MKL_INT)Xw->size[0]);
    }
    /*  Sum of squares of residuals */
    loop_ub = vneg->size[0];
    for (i = 0; i < loop_ub; i++) {
      vneg->data[i] -= r->data[i];
    }
    if (vneg->size[0] == 0) {
      kpos = 0.0;
    } else {
      kpos = cblas_dnrm2((MKL_INT)vneg->size[0], &vneg->data[0], (MKL_INT)1);
    }
    kpos *= kpos;
    outSC_Score_data[3] =
