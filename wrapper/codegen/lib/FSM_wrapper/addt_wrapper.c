                  ...
                  struct9_T *out)
{
  ...
  if (nocheck) {
    ...
    if ((X->size[0] == 0) || (X->size[1] == 0)) {
      ...
      cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans,
                  ...
                  &X->data[0], (MKL_INT)X->size[0], &Aw->data[0],
    ...
    if (intercept) {
      ...
      varargin_2->size[0] = A->size[0];
      varargin_2->size[1] = A->size[1];
      emxEnsureCapacity_real_T(varargin_2, i);
      loop_ub = A->size[0] * A->size[1];
      for (i = 0; i < loop_ub; i++) {
        varargin_2->data[i] = A->data[i];
      }
      i = A->size[0] * A->size[1];
      A->size[0] = r2->size[0];
      A->size[1] = X->size[1] + 1;
      ...
      for (nx = 0; nx < b_i; nx++) {
        A->data[i + nx] = varargin_2->data[nx];
      }
    }
    emxInit_real_T(&r3, 2);
    ...
    if (constcols->size[1] > 1) {
      ...
      for (i = 0; i <= loop_ub; i++) {
        jpvt->data[i] = (int)constcols->data[i + 1];
      }
  ...
  if ((varargin_2->size[0] == 0) || (varargin_2->size[1] == 0) ||
      (E->size[0] == 0) || (E->size[1] == 0)) {
    i = A->size[0] * A->size[1];
    A->size[0] = varargin_2->size[0];
    A->size[1] = E->size[0];
    emxEnsureCapacity_real_T(A, i);
    loop_ub = varargin_2->size[0] * E->size[0];
    for (i = 0; i < loop_ub; i++) {
      A->data[i] = 0.0;
    }
  } else {
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasTrans,
                (MKL_INT)varargin_2->size[0], (MKL_INT)E->size[0],
                (MKL_INT)varargin_2->size[1], 1.0, &varargin_2->data[0],
                (MKL_INT)varargin_2->size[0], &E->data[0], (MKL_INT)E->size[0],
                0.0, &A->data[0], (MKL_INT)varargin_2->size[0]);
  }
  emxFree_real_T(&E);
  if (n < 1) {
    constcols->size[1] = 0;
  ...
  if ((la_size[0] != 0) && (la_size[1] != 0)) {
    ...
    for (loop_ub = 0; loop_ub < nx; loop_ub++) {
      Aw->data[loop_ub] = log(Aw->data[loop_ub]);
    }
    ...
    if (d_y) {
      ...
      b = rt_powd_snf(G, la_data[0] - 1.0);
      i = c_y->size[0];
      c_y->size[0] = b_y->size[0];
      emxEnsureCapacity_real_T(c_y, i);
      nx = b_y->size[0];
      for (loop_ub = 0; loop_ub < nx; loop_ub++) {
        c_y->data[loop_ub] = rt_powd_snf(b_y->data[loop_ub], la_data[0]);
      }
      loop_ub = c_y->size[0];
      for (i = 0; i < loop_ub; i++) {
        c_y->data[i]--;
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0) || (z->size[0] == 0)) {
    i = varargin_2->size[0] * varargin_2->size[1];
    varargin_2->size[0] = A->size[0];
    varargin_2->size[1] = 1;
    emxEnsureCapacity_real_T(varargin_2, i);
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, (MKL_INT)A->size[0],
                ...
                (MKL_INT)A->size[0], &z->data[0], (MKL_INT)z->size[0], 0.0,
                &varargin_2->data[0], (MKL_INT)A->size[0]);
  }
  if ((z->size[0] == 0) || (varargin_2->size[0] == 0)) {
    i = r->size[0] * r->size[1];
    r->size[0] = 1;
    r->size[1] = 1;
    ...
    r->size[1] = 1;
    emxEnsureCapacity_real_T(r, i);
    cblas_dgemm(CblasColMajor, CblasTrans, CblasNoTrans, (MKL_INT)1, (MKL_INT)1,
                (MKL_INT)z->size[0], 1.0, &z->data[0], (MKL_INT)z->size[0],
                &varargin_2->data[0], (MKL_INT)varargin_2->size[0], 0.0,
                &r->data[0], (MKL_INT)1);
  }
  if ((A->size[0] == 0) || (A->size[1] == 0) || (w->size[0] == 0)) {
    i = Aw->size[0];
    Aw->size[0] = A->size[0];
    emxEnsureCapacity_real_T(Aw, i);
    loop_ub = A->size[0];
    ...
    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, (MKL_INT)A->size[0],
                (MKL_INT)1, (MKL_INT)A->size[1], 1.0, &A->data[0],
                (MKL_INT)A->size[0], &w->data[0], (MKL_INT)w->size[0], 0.0,
                &Aw->data[0], (MKL_INT)A->size[0]);
  }
  emxFree_real_T(&A);
  if ((z->size[0] == 0) || (Aw->size[0] == 0)) {
    i = b_y->size[0];
    b_y->size[0] = 1;
    emxEnsureCapacity_real_T(b_y, i);
    b_y->data[0] = 0.0;
    ...
    cblas_dgemm(CblasColMajor, CblasTrans, CblasNoTrans, (MKL_INT)1, (MKL_INT)1,
                (MKL_INT)z->size[0], 1.0, &z->data[0], (MKL_INT)z->size[0],
                &Aw->data[0], (MKL_INT)Aw->size[0], 0.0, &b_y->data[0],
                (MKL_INT)1);
  }
  emxFree_real_T(&z);
  if (w->size[0] < 1) {
    ...
    wAw = cblas_ddot((MKL_INT)w->size[0], &w->data[0], (MKL_INT)1, &Aw->data[0],
                     (MKL_INT)1);
  }
  if (wAw < 1.0E-12) {
    out->S2add.size[0] = 1;
    ...
    /*  b=regress(Az,Aw); */
    out->b.size[0] = 1;
    out->b.data[0] = b_y->data[0] / wAw;
    i = Aw->size[0];
    Aw->size[0] = 1;
    emxEnsureCapacity_real_T(Aw, i);
    Aw->data[0] = r->data[0] - b_y->data[0] * b_y->data[0] / wAw;
    Aw->data[0] = sqrt(Aw->data[0]);
    /*  See Atkinson (1985) p. 98 */
    G = ((double)n - (double)b_i) - 1.0;
    out->S2add.size[0] = 1;
    out->S2add.data[0] = Aw->data[0] * Aw->data[0] / G;
    i = c_y->size[0];
    c_y->size[0] = 1;
    emxEnsureCapacity_real_T(c_y, i);
    c_y->data[0] = fabs(Aw->data[0]);
    i = x->size[0];
    x->size[0] = 1;
    emxEnsureCapacity_boolean_T(x, i);
    x->data[0] = (c_y->data[0] > 1.0E-7);
    if (!x->data[0]) {
      out->Tadd.size[0] = 1;
      out->Tadd.size[1] = 1;
      out->Tadd.data[0] = rtNaN;
      ...
      out->Tadd.size[0] = 1;
      out->Tadd.size[1] = 1;
      out->Tadd.data[0] = b_y->data[0] / Aw->data[0];
      /*  Compute p-value of t-statistic */
      i = varargin_2->size[0] * varargin_2->size[1];
      varargin_2->size[0] = 1;
      varargin_2->size[1] = 1;
      emxEnsureCapacity_real_T(varargin_2, i);
      varargin_2->data[0] = fabs(out->Tadd.data[0]);
      b_tcdf((double *)varargin_2->data, *(int(*)[2])varargin_2->size,
             ((double)n - (double)b_i) - 1.0, (double *)&G, tmp_size);
      i = varargin_2->size[0] * varargin_2->size[1];
      varargin_2->size[0] = tmp_size[0];
      varargin_2->size[1] = tmp_size[1];
      emxEnsureCapacity_real_T(varargin_2, i);
      loop_ub = tmp_size[0] * tmp_size[1];
      for (i = 0; i < loop_ub; i++) {
        varargin_2->data[0] = 1.0 - G;
      }
      out->pval.size[0] = varargin_2->size[0];
      out->pval.size[1] = varargin_2->size[1];
      loop_ub = varargin_2->size[0] * varargin_2->size[1];
      for (i = 0; i < loop_ub; i++) {
        out->pval.data[0] = 2.0 * varargin_2->data[0];
      }
    }
  }
  emxFree_boolean_T(&x);
