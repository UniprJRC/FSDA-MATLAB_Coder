 ...
 *
 * _coder_FSMbsb_wrapper_api.h
 *
 * Code generation for function 'FSMbsb_wrapper'
 *
 */

#ifndef _CODER_FSMBSB_WRAPPER_API_H
#define _CODER_FSMBSB_WRAPPER_API_H
...
void FSMbsb_wrapper_xil_shutdown(void);

void FSMbsb_wrapper_xil_terminate(void);
...
#endif
/* End of code generation (_coder_FSMbsb_wrapper_api.h) */
