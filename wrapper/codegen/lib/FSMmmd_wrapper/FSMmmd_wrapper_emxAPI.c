 ...
 *
 * FSMmmd_wrapper_emxAPI.c
 *
 * Code generation for function 'FSMmmd_wrapper_emxAPI'
 *
 */

/* Include files */
#include "FSMmmd_wrapper_emxAPI.h"
...
/* End of code generation (FSMmmd_wrapper_emxAPI.c) */
