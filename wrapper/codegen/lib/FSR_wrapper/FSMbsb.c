    ...
    while (Ra && (nwhile < 100)) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
             partialTrueCount++) {
          R->data[partialTrueCount + R->size[0] * i] =
        ...
        if (b_mm <= percn) {
          ...
          for (i = 0; i < loop_ub; i++) {
            ...
            for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                 partialTrueCount++) {
              Yb->data[partialTrueCount + Yb->size[0] * i] =
                  Y->data[(r4->data[partialTrueCount] + Y->size[0] * i) - 1];
            }
          }
        }
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                for (partialTrueCount = 0; partialTrueCount < b_loop_ub;
                     partialTrueCount++) {
                  R->data[partialTrueCount + R->size[0] * i] =
                      Y->data[(r9->data[partialTrueCount] + Y->size[0] * i) -
                              1];
                }
              }
              combineVectorElements(R, mibsbr);
