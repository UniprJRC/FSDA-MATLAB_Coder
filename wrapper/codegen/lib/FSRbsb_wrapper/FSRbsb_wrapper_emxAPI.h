 ...
 *
 * FSRbsb_wrapper_emxAPI.h
 *
 * Code generation for function 'FSRbsb_wrapper_emxAPI'
 *
 */

#ifndef FSRBSB_WRAPPER_EMXAPI_H
#define FSRBSB_WRAPPER_EMXAPI_H
...
#endif
/* End of code generation (FSRbsb_wrapper_emxAPI.h) */
