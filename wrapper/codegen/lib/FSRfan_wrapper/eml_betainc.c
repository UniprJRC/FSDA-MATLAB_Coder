...
double eml_betainc(double x, double a, double lbeta, bool upper)
{
  double log1mx;
  double logx;
  double rval;
    ...
    if (rtIsInf(a)) {
      ...
      if (a + 0.5 < 1.0E+7) {
        ...
        if (x < (a + 1.0) / ((a + 0.5) + 2.0)) {
          rval = exp(((a * logx + 0.5 * log1mx) - log(a)) - lbeta) *
                 betainc_cf(x, a, 0.5);
          if (upper) {
            rval = 1.0 - rval;
          }
          ...
          rval =
              exp(((a * logx + 0.5 * log1mx) - -0.69314718055994529) - lbeta) *
      ...
      if (guard1) {
        logx = rt_powd_snf(0.5 * x, 0.33333333333333331);
        log1mx = rt_powd_snf(a * (1.0 - x), 0.33333333333333331);
        if (((a + 0.5) - 1.0) * (1.0 - x) > 0.8) {
          logx =
              3.0 *
              (0.77777777777777779 * logx - (1.0 - 1.0 / (9.0 * a)) * log1mx) /
              sqrt(logx * logx / 0.5 + log1mx * log1mx / a);
          if (upper) {
          ...
          logx = 0.5;
          gammaln(&logx);
          rval = eml_gammainc(0.5 * (((a + 0.5) - 1.0) * (3.0 - x) - -0.5) *
                                  (1.0 - x),
                              logx, !upper);
        }
      }
