...
double eml_gammainc(double x, double lgap1, bool upper)
{
  double dj;
  double old;
  double rval;
  ...
  if (!(x > 0.0)) {
    ...
    if (x > 1.0E+6) {
        ...
        dj = 0.5 *
             ((((((((((((((((((((((0.0012710976495261409 * (dj - 0.5) +
               ...
               0.49016508058531844) *
                  (dj - 0.5) +
              0.27537474159737679) *
             dj * exp(-v * v) * 2.5066282746310002 * exp(0.5 * tsq);
      ...
      if (-0.72579135264472727 - xD0 < 709.782712893384) {
        rval = exp(-0.72579135264472727 - xD0) * v;
      } else {
        rval = exp((-0.72579135264472727 - xD0) + log(v));
      }
      if (!upper) {
        rval = 1.0 - rval;
      }
      ...
      for (b_i = 0; b_i < i; b_i++) {
        v = x * (v + 1.0) / (((dj - 1.0) + -(double)b_i) + 0.5);
      }
      v++;
      if (-0.72579135264472727 - xD0 < 709.782712893384) {
        rval = exp(-0.72579135264472727 - xD0) * v;
      ...
      if ((int)dj <= i) {
        ...
        v = sqrt(3.1415926535897931 * x) * exp(x) *
            (2.0 * (0.5 *
      ...
      i = (int)(((-1.0 - (dj - 1.0)) + 1.0) / -1.0);
      for (b_i = 0; b_i < i; b_i++) {
        v = (0.5 - ((dj - 1.0) + -(double)b_i)) * v / x + 1.0;
      }
      v = v * 0.5 / x;
      if (-0.72579135264472727 - xD0 < 709.782712893384) {
        rval = exp(-0.72579135264472727 - xD0) * v;
