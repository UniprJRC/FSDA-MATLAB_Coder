    ...
    if (x == 0.0) {
      ...
      for (k = 0; k < 2; k++) {
        z = (eml_erfcore(-b_x) - (2.0 - x)) /
            (1.1283791670955126 * exp(-b_x * b_x));
        b_x -= z / (b_x * z + 1.0);
      }
    } else if (x < 0.3) {
      z = sqrt(0.69314718055994529 - log(x));
      ...
      for (k = 0; k <= nIterations; k++) {
        z = -(eml_erfcore(b_x) - x) / (1.1283791670955126 * exp(-b_x * b_x));
        b_x -= z / (b_x * z + 1.0);
      }
    } else {
      z = (1.0 - x) * (1.0 - x);
      ...
      for (k = 0; k < 2; k++) {
        ...
        if (rtIsNaN(b_x)) {
          ...
          z = exp(-z * z - 0.5625) * exp((z - absx) * (z + absx) + R / S) /
              absx;
          if (b_x < 0.0) {
            z--;
          } else {
