 ...
 *
 * LXS_wrapper_emxAPI.h
 *
 * Code generation for function 'LXS_wrapper_emxAPI'
 *
 */

#ifndef LXS_WRAPPER_EMXAPI_H
#define LXS_WRAPPER_EMXAPI_H
...
#endif
/* End of code generation (LXS_wrapper_emxAPI.h) */
