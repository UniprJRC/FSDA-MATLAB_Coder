 ...
 *
 * _coder_LXS_wrapper_api.h
 *
 * Code generation for function 'LXS_wrapper'
 *
 */

#ifndef _CODER_LXS_WRAPPER_API_H
#define _CODER_LXS_WRAPPER_API_H
...
void LXS_wrapper(emxArray_real_T *y, emxArray_real_T *X,
                 ...
                 real_T nsamp, boolean_T rew, boolean_T yxsave, struct0_T *out,
                 emxArray_real_T *C);
...
void LXS_wrapper_xil_shutdown(void);

void LXS_wrapper_xil_terminate(void);
...
#endif
/* End of code generation (_coder_LXS_wrapper_api.h) */
