...
static struct0_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *lms,
                                    const char_T *identifier);

static struct0_T l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                    const emlrtMsgIdentifier *parentId);
                                    ...
                                    const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = l_emlrt_marshallIn(sp, emlrtAlias(lms), &thisId);
                      ...
                      const mxArray *plhs[2])
{
  ...
  lms = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "lms");
...
void LXS_wrapper1_atexit(void)
{
  ...
  LXS_wrapper1_xil_terminate();
  LXS_wrapper1_xil_shutdown();
