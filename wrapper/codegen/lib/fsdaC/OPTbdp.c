...
double OPTbdp(double bdp)
{
  ...
  while (fabs(Erho1 - 1.0) > 1.0E-10) {
    ...
    b = Erho1 / 2.0;
    a = 2.0 * Erho1 / 9.0;
    b_tmp = gammainc(a, 1.5);
    b_b_tmp = gammainc(b, 0.5);
    Erho1 = ((((((1.3846 / Erho1 * b_tmp.re +
                  0.5514 * (b_b_tmp.re - (gammainc(a, 0.5)).re)) -
                 2.6917 / Erho1 * ((gammainc(b, 1.5)).re - b_tmp.re)) +
                10.7668 / rt_powd_snf(c, 4.0) * 3.0 *
                    ((gammainc(b, 2.5)).re - (gammainc(a, 2.5)).re)) +
               -(11.664 / rt_powd_snf(c, 6.0)) * 3.0 * 5.0 *
                   ((gammainc(b, 3.5)).re - (gammainc(a, 3.5)).re)) +
