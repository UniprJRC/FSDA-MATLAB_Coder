...
## Generated on : Thu Jun 10 09:56:33 2021
...
restrdeter.obj : $(START_DIR)/restrdeter.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
matrix_to_integer_power.obj : $(START_DIR)/matrix_to_integer_power.c
	$(CC) $(CFLAGS) -o "$@" "$<"
