...
static void emxFreeStruct_cell_wrap_39(cell_wrap_39 *pStruct);
...
static void emxFree_cell_wrap_39(emxArray_cell_wrap_39 **pEmxArray);

static void emxFree_char_T(emxArray_char_T **pEmxArray);

static void emxFree_real_T(emxArray_real_T **pEmxArray);

static void emxInitMatrix_cell_wrap_51(cell_wrap_51 *pMatrix);

static void emxInitMatrix_cell_wrap_53(cell_wrap_53 pMatrix[4]);

static void emxInitMatrix_cell_wrap_6(const emlrtStack *sp,
                                      cell_wrap_6 pMatrix[4], boolean_T doPush);

static void emxInitStruct_cell_wrap_51(cell_wrap_51 *pStruct);

static void emxInitStruct_cell_wrap_53(cell_wrap_53 *pStruct);
...
static void emxInit_cell_wrap_39(const emlrtStack *sp,
                                 emxArray_cell_wrap_39 **pEmxArray,
                                 int32_T numDimensions, boolean_T doPush);
...
static const mxArray *q_emlrt_marshallOut(const struct_addt_T u);
...
static const mxArray *r_emlrt_marshallOut(const real_T u_data[],
...
static const mxArray *s_emlrt_marshallOut(const struct_tclust_T *u);
...
static const mxArray *emlrt_marshallOut(const emlrtStack *sp,
                                        const struct_FSM_T *u)
{
  static const char_T *b_sv[8] = {"outliers", "loc", "cov",  "md",
                                  "mmd",      "Un",  "nout", "class"};
  const mxArray *b_y;
  const mxArray *c_y;
  const mxArray *m;
  ...
  emlrtInitCharArrayR2013a((emlrtCTX)sp, u->class.size[1], m,
                           &u->class.data[0]);
  emlrtAssign(&c_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"class", c_y, 7);
  return y;
}
                                          ...
                                          boolean_T doPush)
{
  ...
  emxInit_cell_wrap_39(sp, &pStruct->Un, 1, doPush);
                                 ...
                                 int32_T numDimensions, boolean_T doPush)
{
  ...
  int32_T i;
  *pEmxArray =
      (emxArray_cell_wrap_39 *)emlrtMallocMex(sizeof(emxArray_cell_wrap_39));
  if (doPush) {
    emlrtPushHeapReferenceStackR2021a((emlrtCTX)sp, false, (void *)pEmxArray,
                                      (void *)&emxFree_cell_wrap_39, NULL, NULL,
                                      NULL);
  }
  emxArray = *pEmxArray;
                                          ...
                                          const struct0_T *u)
{
  ...
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 13, (const char_T **)&sv[0]));
  emlrtSetFieldR2017b(y, 0, (const char_T *)"ListOut",
                      c_emlrt_marshallOut(u->ListOut), 0);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"outliers",
                      f_emlrt_marshallOut(u->outliers), 1);
  b_y = NULL;
  iv[0] = u->mdr->size[0];
  ...
  m = emlrtCreateDoubleScalar(u->scale);
  emlrtAssign(&c_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"scale", c_y, 6);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"mdag",
                      c_emlrt_marshallOut(u->mdag), 7);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"ListCl",
                      f_emlrt_marshallOut(u->ListCl), 8);
...
static const mxArray *i_emlrt_marshallOut(const struct_FSRfan_T *u)
{
  static const char_T *b_sv[9] = {"Score", "la",     "bs",     "Un",    "y",
  ...
  int32_T i1;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 9, (const char_T **)&b_sv[0]));
                                          ...
                                          const struct_LTSts_T *u)
{
  ...
  static const char_T *b_sv[24] = {"RES",
                                   "Hsubset",
                                   "B",
                                   "posLS",
                                   "yhat",
  ...
  int32_T i;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 24, (const char_T **)&b_sv[0]));
...
static const mxArray *l_emlrt_marshallOut(const emlrtStack *sp, const table *u)
{
  ...
  static const char_T *b_sv[2] = {"Description", "UserData"};
  ...
  *pData = (int32_T)u->varDim.continuity[0];
  ...
  ab_y = NULL;
  emlrtAssign(&ab_y,
              emlrtCreateStructMatrix(1, 1, 2, (const char_T **)&b_sv[0]));
  bb_y = NULL;
  iv[0] = 1;
  iv[1] = 0;
  m7 = emlrtCreateCharArray(2, &iv[0]);
                                          ...
                                          const struct_LXS_T *u)
{
  ...
  int32_T i;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 13, (const char_T **)&b_sv[0]));
  b_y = NULL;
  i = u->weights->size[0];
  m = emlrtCreateLogicalArray(1, &i);
  emlrtInitLogicalArray(u->weights->size[0], m, &u->weights->data[0]);
                                          ...
                                          const struct_MMreg_T *u)
{
  ...
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 16, (const char_T **)&b_sv[0]));
  emlrtSetFieldR2017b(y, 0, (const char_T *)"beta",
                      g_emlrt_marshallOut(u->beta), 0);
  b_y = NULL;
  m = emlrtCreateDoubleScalar(u->auxscale);
  emlrtAssign(&b_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"auxscale", b_y, 1);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"fittedvalues",
  ...
  c_y = NULL;
  m = emlrtCreateDoubleScalar(u->Ssingsub);
  emlrtAssign(&c_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"Ssingsub", c_y, 5);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"weights",
                      c_emlrt_marshallOut(u->weights), 6);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"outliers",
                      f_emlrt_marshallOut(u->outliers), 7);
  d_y = NULL;
  m = emlrtCreateDoubleScalar(u->conflev);
  emlrtAssign(&d_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"conflev", d_y, 8);
  e_y = NULL;
  m = emlrtCreateCharArray(2, &iv[0]);
  emlrtInitCharArrayR2013a((emlrtCTX)sp, 5, m, &u->class[0]);
  emlrtAssign(&e_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"class", e_y, 9);
  ...
  emlrtInitCharArrayR2013a((emlrtCTX)sp,
                           ...
                           &b_u->data[0]);
  emlrtAssign(&f_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"rhofuncS", f_y, 10);
  ...
  emlrtInitCharArrayR2013a((emlrtCTX)sp,
                           ...
                           &b_u->data[0]);
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"rhofunc", g_y, 12);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"rhofuncparam",
                      c_emlrt_marshallOut(u->rhofuncparam), 13);
                                          ...
                                          const struct_Sreg_T *u)
{
  ...
  int32_T iv[2];
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 14, (const char_T **)&b_sv[0]));
  emlrtSetFieldR2017b(y, 0, (const char_T *)"beta",
                      g_emlrt_marshallOut(u->beta), 0);
  b_y = NULL;
  m = emlrtCreateDoubleScalar(u->scale);
  emlrtAssign(&b_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"scale", b_y, 1);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"bs", f_emlrt_marshallOut(u->bs),
                      2);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"weights",
                      c_emlrt_marshallOut(u->weights), 3);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"fittedvalues",
  ...
  m = emlrtCreateDoubleScalar(u->singsub);
  emlrtAssign(&c_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"singsub", c_y, 6);
  d_y = NULL;
  m = emlrtCreateDoubleScalar(u->conflev);
  emlrtAssign(&d_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"conflev", d_y, 7);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"outliers",
  ...
  emlrtInitCharArrayR2013a((emlrtCTX)sp,
                           ...
                           &u->rhofunc->data[0]);
  emlrtAssign(&e_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"rhofunc", e_y, 9);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"rhofuncparam",
                      c_emlrt_marshallOut(u->rhofuncparam), 10);
  ...
  emlrtAssign(&f_y, m);
  emlrtSetFieldR2017b(y, 0, (const char_T *)"class", f_y, 13);
  return y;
}
...
static const mxArray *s_emlrt_marshallOut(const struct_tclust_T *u)
{
  ...
  int32_T i;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 15, (const char_T **)&b_sv[0]));
...
void FSR_wrapper1_api(const mxArray *const prhs[13], const mxArray **plhs)
{
  ...
  /* Marshall function outputs */
  *plhs = h_emlrt_marshallOut(&st, &out);
                       ...
                       const mxArray *plhs[2])
{
  ...
  emxArray_real_T *y;
  struct2_T InitialEst;
  struct2_T b_InitialEst;
  struct_MMreg_T out;
  real_T Sbdp;
  real_T Sbestr;
  real_T Sminsctol;
  ...
  emxInit_real_T(&st, &y, 1, true);
  emxInit_real_T(&st, &X, 2, true);
  emxInitStruct_struct2_T(&st, &InitialEst, true);
  ...
  emxFreeStruct_struct2_T(&InitialEst);
  emxFree_real_T(&X);
  emxFree_real_T(&y);
  if (nlhs > 1) {
    C->canFreeData = false;
                         ...
                         const mxArray *plhs[2])
{
  ...
  tclust_wrapper1(Y, k, alpha, &restrfactor, equalweights, mixt, msg, nocheck,
                  ...
                  &out, C);
  /* Marshall function outputs */
  plhs[0] = s_emlrt_marshallOut(&out);
