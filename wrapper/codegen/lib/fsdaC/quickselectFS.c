 ...
 * the desired order statistic. Data Types - double
 *
 *
 *
 ...
 *  Output:
 *
 *  kE : k-th order statistic. Scalar. Element in A that is larger than exactly
 * k - 1 other elements of A.
 *
 *  Optional Output:
 *
 ...
 *
 *
 * <a href="matlab: docsearchFS('quickselectFS')">Link to the help page for this
 * function</a>
 *
...
/*
 * File trailer for quickselectFS.c
 *
 * [EOF]
 */
