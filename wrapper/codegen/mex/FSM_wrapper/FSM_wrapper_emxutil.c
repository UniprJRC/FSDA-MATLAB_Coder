                                ...
                                boolean_T doPush)
{
  ...
  emxInit_real_T(sp, &pStruct->loc, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->cov, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->md, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->mmd, 2, srcLocation, doPush);
...
/* End of code generation (FSM_wrapper_emxutil.c) */
