               ...
               emxArray_real_T *MMDenv)
{
  ...
  emxInit_real_T(sp, &y, 2, &po_emlrtRTEI, true);
  ...
  emxInit_real_T(&b_st, &m, 1, &un_emlrtRTEI, true);
  i = m->size[0];
  m->size[0] = y->size[1];
  emxEnsureCapacity_real_T(sp, m, i, &un_emlrtRTEI);
  loop_ub = y->size[1];
  for (i = 0; i < loop_ub; i++) {
    m->data[i] = y->data[i];
  }
  emxFree_real_T(&y);
  emxInit_real_T(sp, &mm, 2, &vn_emlrtRTEI, true);
  emxInit_real_T(sp, &b_y, 2, &eo_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T(sp, mm, i, &vn_emlrtRTEI);
  loop_ub = b_y->size[0] * b_y->size[1];
  for (i = 0; i < loop_ub; i++) {
    mm->data[i] = b_y->data[i];
  }
  emxInit_real_T(sp, &a, 2, &ko_emlrtRTEI, true);
  /*  finv finds the inverse of the F distribution. */
  i = a->size[0] * a->size[1];
  a->size[0] = mm->size[0];
  a->size[1] = 6;
  emxEnsureCapacity_real_T(sp, a, i, &wn_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
    a->data[i] = n - mm->data[i];
  }
  emxInit_real_T(sp, &b_tmp, 2, &xn_emlrtRTEI, true);
  i = b_tmp->size[0] * b_tmp->size[1];
  b_tmp->size[0] = mm->size[0];
  b_tmp->size[1] = 6;
  emxEnsureCapacity_real_T(sp, b_tmp, i, &xn_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(sp, &b_mm, 2, &go_emlrtRTEI, true);
  st.site = &fy_emlrtRSI;
  c_repmat(&st, tmp_data, z_size, m->size[0], b_y);
  i = b_mm->size[0] * b_mm->size[1];
  b_mm->size[0] = a->size[0];
  b_mm->size[1] = 6;
  emxEnsureCapacity_real_T(sp, b_mm, i, &yn_emlrtRTEI);
  loop_ub = a->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
    b_mm->data[i] = 2.0 * a->data[i];
  }
  emxInit_real_T(sp, &c_y, 2, &qo_emlrtRTEI, true);
  i = c_y->size[0] * c_y->size[1];
  c_y->size[0] = b_tmp->size[0];
  c_y->size[1] = 6;
  emxEnsureCapacity_real_T(sp, c_y, i, &yn_emlrtRTEI);
  loop_ub = b_tmp->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
    c_y->data[i] = 2.0 * b_tmp->data[i];
  }
  emxInit_real_T(sp, &quant, 2, &ao_emlrtRTEI, true);
  emxInit_real_T(sp, &d_y, 2, &co_emlrtRTEI, true);
  st.site = &fy_emlrtRSI;
  c_finv(&st, b_y, b_mm, c_y, d_y);
  i = quant->size[0] * quant->size[1];
  quant->size[0] = d_y->size[0];
  quant->size[1] = d_y->size[1];
  emxEnsureCapacity_real_T(sp, quant, i, &ao_emlrtRTEI);
  ...
  emlrtSizeEqCheckNDR2012b(&z_size[0], &iv[0], &ob_emlrtECI, (emlrtCTX)sp);
  loop_ub = a->size[0] * 6;
  i = a->size[0] * a->size[1];
  a->size[1] = 6;
  emxEnsureCapacity_real_T(sp, a, i, &bo_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emlrtSizeEqCheckNDR2012b(&z_size[0], &iv[0], &pb_emlrtECI, (emlrtCTX)sp);
  st.site = &ey_emlrtRSI;
  i = d_y->size[0] * d_y->size[1];
  d_y->size[0] = mm->size[0];
  d_y->size[1] = 6;
  emxEnsureCapacity_real_T(&st, d_y, i, &co_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  c_y->size[0] = b_tmp->size[0];
  c_y->size[1] = 6;
  emxEnsureCapacity_real_T(sp, c_y, i, &do_emlrtRTEI);
  loop_ub = b_tmp->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  emlrtSizeEqCheckNDR2012b(&z_size[0], &iv[0], &qb_emlrtECI, (emlrtCTX)sp);
  st.site = &dy_emlrtRSI;
  ...
  b_y->size[1] = 6;
  emxEnsureCapacity_real_T(&st, b_y, i, &eo_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(&b_st, &b_b_tmp, 2, &fo_emlrtRTEI, true);
  ...
  b_b_tmp->size[1] = 6;
  emxEnsureCapacity_real_T(sp, b_b_tmp, i, &fo_emlrtRTEI);
  loop_ub = b_tmp->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  b_mm->size[1] = 6;
  emxEnsureCapacity_real_T(sp, b_mm, i, &go_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  a->size[0] = b_y->size[0];
  a->size[1] = b_y->size[1];
  emxEnsureCapacity_real_T(sp, a, i, &ho_emlrtRTEI);
  loop_ub = b_y->size[0] * b_y->size[1];
  ...
  iv[0] = (*(int32_T(*)[2])a->size)[0];
  iv[1] = (*(int32_T(*)[2])a->size)[1];
  emlrtSizeEqCheckNDR2012b(&z_size[0], &iv[0], &rb_emlrtECI, (emlrtCTX)sp);
  loop_ub = c_y->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
    c_y->data[i] *= a->data[i];
  }
  ...
  emxEnsureCapacity_real_T(sp, quant, i, &io_emlrtRTEI);
  ...
  b_mm->size[0] = mm->size[0];
  b_mm->size[1] = 6;
  emxEnsureCapacity_real_T(sp, b_mm, i, &jo_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  a->size[0] = b_y->size[0];
  a->size[1] = b_y->size[1];
  emxEnsureCapacity_real_T(sp, a, i, &ko_emlrtRTEI);
  loop_ub = b_y->size[0] * b_y->size[1];
  emxFree_real_T(&b_mm);
  for (i = 0; i < loop_ub; i++) {
    a->data[i] = b_y->data[i];
  ...
  a->size[0] = b_y->size[0];
  a->size[1] = b_y->size[1];
  emxEnsureCapacity_real_T(sp, a, i, &lo_emlrtRTEI);
  loop_ub = b_y->size[0] * b_y->size[1];
  for (i = 0; i < loop_ub; i++) {
    a->data[i] = b_y->data[i];
  }
  ...
  iv[0] = (*(int32_T(*)[2])a->size)[0];
  iv[1] = (*(int32_T(*)[2])a->size)[1];
  emlrtSizeEqCheckNDR2012b(&z_size[0], &iv[0], &sb_emlrtECI, (emlrtCTX)sp);
  st.site = &yx_emlrtRSI;
  i = d_y->size[0] * d_y->size[1];
  d_y->size[0] = mm->size[0];
  d_y->size[1] = 6;
  emxEnsureCapacity_real_T(&st, d_y, i, &mo_emlrtRTEI);
  loop_ub = mm->size[0] * 6;
  for (i = 0; i < loop_ub; i++) {
  ...
  d_y->size[1] = 6;
  emxEnsureCapacity_real_T(&b_st, d_y, i, &no_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&b_st, MMDenv, i, &oo_emlrtRTEI);
                 ...
                 emxArray_real_T *MMDenv)
{
  ...
  emxFree_real_T(&y);
  emxInit_real_T(sp, &mm, 2, &vn_emlrtRTEI, true);
  emxInit_real_T(sp, &b_y, 2, &co_emlrtRTEI, true);
  /*  mm = fwd search index replicated lp times. */
  st.site = &gy_emlrtRSI;
  ...
  emxInit_real_T(sp, &c_y, 2, &eo_emlrtRTEI, true);
  emxInit_real_T(sp, &r, 2, &xo_emlrtRTEI, true);
  st.site = &fy_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&st, b_y, i, &co_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(&g_st, &d_y, 2, &qo_emlrtRTEI, true);
  i = d_y->size[0] * d_y->size[1];
  d_y->size[0] = b_tmp->size[0];
  d_y->size[1] = b_tmp->size[1];
  emxEnsureCapacity_real_T(sp, d_y, i, &do_emlrtRTEI);
  loop_ub = b_tmp->size[0] * b_tmp->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&st, c_y, i, &eo_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(sp, c_y, i, &fo_emlrtRTEI);
  loop_ub = b_tmp->size[0] * b_tmp->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  b_y->size[0] = mm->size[0];
  b_y->size[1] = mm->size[1];
  emxEnsureCapacity_real_T(&st, b_y, i, &mo_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&b_st, b_y, i, &no_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  MMDenv->size[1] = input_sizes_idx_1 + csz_idx_1;
  emxEnsureCapacity_real_T(sp, MMDenv, i, &oo_emlrtRTEI);
  loop_ub = input_sizes_idx_1;
  for (i = 0; i < loop_ub; i++) {
                 ...
                 emxArray_real_T *MMDenv)
{
  ...
  emxFree_real_T(&y);
  emxInit_real_T(sp, &mm, 2, &vn_emlrtRTEI, true);
  emxInit_real_T(sp, &b_tmp, 2, &wn_emlrtRTEI, true);
  /*  mm = fwd search index replicated lp times. */
  st.site = &gy_emlrtRSI;
  ...
  b_tmp->size[0] = mm->size[0];
  b_tmp->size[1] = mm->size[1];
  emxEnsureCapacity_real_T(sp, b_tmp, i, &wn_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
    b_tmp->data[i] = n - mm->data[i];
  }
  emxInit_real_T(sp, &b_b_tmp, 2, &xn_emlrtRTEI, true);
  i = b_b_tmp->size[0] * b_b_tmp->size[1];
  b_b_tmp->size[0] = mm->size[0];
  b_b_tmp->size[1] = mm->size[1];
  emxEnsureCapacity_real_T(sp, b_b_tmp, i, &xn_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(sp, &c_b_tmp, 2, &fo_emlrtRTEI, true);
  i = c_b_tmp->size[0] * c_b_tmp->size[1];
  c_b_tmp->size[0] = b_b_tmp->size[0];
  c_b_tmp->size[1] = b_b_tmp->size[1];
  emxEnsureCapacity_real_T(sp, c_b_tmp, i, &yn_emlrtRTEI);
  ...
  b_tmp->size[0] = mm->size[0];
  b_tmp->size[1] = mm->size[1];
  emxEnsureCapacity_real_T(&st, b_tmp, i, &co_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    b_tmp->data[i] += mm->data[i] + 1.0;
  }
  b_st.site = &nx_emlrtRSI;
  ...
  emxInit_real_T(&g_st, &cor, 2, &yo_emlrtRTEI, true);
  i = cor->size[0] * cor->size[1];
  cor->size[0] = b_b_tmp->size[0];
  cor->size[1] = b_b_tmp->size[1];
  emxEnsureCapacity_real_T(sp, cor, i, &qo_emlrtRTEI);
  loop_ub = b_b_tmp->size[0] * b_b_tmp->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&st, quant, i, &eo_emlrtRTEI);
  loop_ub = mm->size[0] * mm->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  c_b_tmp->size[0] = b_b_tmp->size[0];
  c_b_tmp->size[1] = b_b_tmp->size[1];
  emxEnsureCapacity_real_T(sp, c_b_tmp, i, &fo_emlrtRTEI);
  loop_ub = b_b_tmp->size[0] * b_b_tmp->size[1];
  for (i = 0; i < loop_ub; i++) {
