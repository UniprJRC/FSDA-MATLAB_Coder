               ...
               emxArray_real_T *x)
{
  ...
  x->size[0] = p->size[0];
  x->size[1] = p->size[1];
  emxEnsureCapacity_real_T(&st, x, i, &ro_emlrtRTEI);
  i = p->size[0] * p->size[1];
  for (k = 0; k < i; k++) {
    i1 = p->size[0] * p->size[1];
    if ((k + 1 < 1) || (k + 1 > i1)) {
      emlrtDynamicBoundsCheckR2012b(k + 1, 1, i1, &lo_emlrtBCI, &st);
    }
    if ((!muDoubleScalarIsInf(a)) && (p->data[k] >= 0.0) &&
      ...
      if ((p->data[k] > 0.0) && (p->data[k] < 1.0) && (a > 0.0)) {
        ...
        if (muDoubleScalarHypot(dc1.re - p->data[k], dc1.im) >
          ...
          e_emlrt_marshallIn(&c_st, b_sprintf(&c_st, y, b_y, &yb_emlrtMCI),
          ...
          emlrtAssign(&d_y, m);
          c_st.site = &qeb_emlrtRSI;
          e_emlrt_marshallIn(&c_st, b_sprintf(&c_st, c_y, d_y, &yb_emlrtMCI),
          ...
          emlrtAssign(&f_y, m);
          c_st.site = &qeb_emlrtRSI;
          e_emlrt_marshallIn(&c_st, b_sprintf(&c_st, e_y, f_y, &yb_emlrtMCI),
        ...
        if (((int32_T)(k + 1U) < 1) || ((int32_T)(k + 1U) > i1)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)(k + 1U), 1, i1, &qo_emlrtBCI,
                                        &st);
        }
        x->data[k] = dc.re * 2.0;
        ...
        i1 = x->size[0] * x->size[1];
        if (((int32_T)(k + 1U) < 1) || ((int32_T)(k + 1U) > i1)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)(k + 1U), 1, i1, &no_emlrtBCI,
                                        &st);
        }
        x->data[k] = 0.0;
        ...
        i1 = x->size[0] * x->size[1];
        if (((int32_T)(k + 1U) < 1) || ((int32_T)(k + 1U) > i1)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)(k + 1U), 1, i1, &po_emlrtBCI,
                                        &st);
        }
        x->data[k] = rtInf;
      } else {
        i1 = x->size[0] * x->size[1];
        if (((int32_T)(k + 1U) < 1) || ((int32_T)(k + 1U) > i1)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)(k + 1U), 1, i1, &oo_emlrtBCI,
                                        &st);
        }
        x->data[k] = rtNaN;
      }
      ...
      i1 = x->size[0] * x->size[1];
      if (((int32_T)(k + 1U) < 1) || ((int32_T)(k + 1U) > i1)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)(k + 1U), 1, i1, &mo_emlrtBCI,
                                      &st);
      }
      x->data[k] = rtNaN;
    }
