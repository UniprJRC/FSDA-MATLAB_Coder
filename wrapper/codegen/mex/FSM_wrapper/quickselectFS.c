                     ...
                     real_T kiniindex)
{
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &kn_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &mn_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  ...
  while (Ak != k) {
    ...
    if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &pn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    pivot = A->data[(int32_T)k - 1];
    /*  Swap right sentinel and pivot element */
    if ((right < 1) || (right > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &qn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &rn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    A->data[(int32_T)k - 1] = A->data[right - 1];
    if (right > A->size[0]) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &sn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    for (b_i = 0; b_i <= i; b_i++) {
      ...
      if (((int32_T)c_i < 1) || ((int32_T)c_i > A->size[0])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)c_i, 1, A->size[0], &vn_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    ...
    if (((int32_T)Ak < 1) || ((int32_T)Ak > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)Ak, 1, A->size[0], &tn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (right > A->size[0]) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &un_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    A->data[right - 1] = A->data[(int32_T)Ak - 1];
    if (((int32_T)Ak < 1) || ((int32_T)Ak > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)Ak, 1, A->size[0], &wn_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &on_emlrtBCI,
                                  (emlrtCTX)sp);
  }
