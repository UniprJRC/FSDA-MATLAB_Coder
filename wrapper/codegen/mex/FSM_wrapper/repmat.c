              ...
              emxArray_real_T *b)
{
  ...
  if ((varargin_2 != varargin_2) || muDoubleScalarIsInf(varargin_2)) {
    emlrtErrorWithMessageIdR2018a(
        &st, &s_emlrtRTEI, "Coder:MATLAB:NonIntegerInput",
  ...
  if (!(b_varargin_2 <= 2.147483647E+9)) {
    emlrtErrorWithMessageIdR2018a(&st, &lb_emlrtRTEI, "Coder:MATLAB:pmaxsize",
  ...
  emxEnsureCapacity_real_T(sp, b, nrows, &sn_emlrtRTEI);
  nrows = a->size[0];
  st.site = &jx_emlrtRSI;
              ...
              const int32_T a_size[2], real_T varargin_1, emxArray_real_T *b)
{
  ...
  b->size[0] = nrows;
  b->size[1] = a_size[1];
  emxEnsureCapacity_real_T(sp, b, ncols, &sn_emlrtRTEI);
  nrows = a_size[0];
  ncols = a_size[1];
...
void d_repmat(const emlrtStack *sp, real_T varargin_1, emxArray_real_T *b)
{
  ...
  b->size[1] = 1;
  emxEnsureCapacity_real_T(sp, b, itilerow, &sn_emlrtRTEI);
  st.site = &lx_emlrtRSI;
            ...
            emxArray_ptrdiff_t *b)
{
  ...
  i = b->size[0];
  b->size[0] = varargin_1;
  emxEnsureCapacity_ptrdiff_t(sp, b, i, &dm_emlrtRTEI);
