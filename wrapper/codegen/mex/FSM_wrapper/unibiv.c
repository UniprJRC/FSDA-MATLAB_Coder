...
static emlrtRSInfo fi_emlrtRSI = { 27, /* lineNo */
  "sort",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2021a\\toolbox\\eml\\lib\\matlab\\datafun\\sort.m"/* pathName */
};

static emlrtRSInfo pj_emlrtRSI = { 29, /* lineNo */
...
static emlrtRTEInfo gf_emlrtRTEI = { 86,/* lineNo */
  13,                                  /* colNo */
...
static emlrtRTEInfo xf_emlrtRTEI = { 27,/* lineNo */
  6,                                   /* colNo */
  "sort",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2021a\\toolbox\\eml\\lib\\matlab\\datafun\\sort.m"/* pName */
};

static emlrtRTEInfo yf_emlrtRTEI = { 28,/* lineNo */
  5,                                   /* colNo */
  "sort",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2021a\\toolbox\\eml\\lib\\matlab\\datafun\\sort.m"/* pName */
};
  ...
  emxArray_real_T *r)
{
  ...
  emxInit_real_T(sp, &tieloc, 1, &dg_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T(&st, tieloc, i, &xf_emlrtRTEI);
  loop_ub = x->size[0];
  for (i = 0; i < loop_ub; i++) {
    tieloc->data[i] = x->data[i];
  }

  emxInit_int32_T(&st, &rowidx, 1, &ig_emlrtRTEI, true);
  emxInit_int32_T(&st, &ii, 1, &kg_emlrtRTEI, true);
  b_st.site = &fi_emlrtRSI;
  sort(&b_st, tieloc, ii);
  i = rowidx->size[0];
  rowidx->size[0] = ii->size[0];
  emxEnsureCapacity_int32_T(&st, rowidx, i, &yf_emlrtRTEI);
  loop_ub = ii->size[0];
  for (i = 0; i < loop_ub; i++) {
    rowidx->data[i] = ii->data[i];
  }

  emxInit_boolean_T(&st, &b_x, 1, &ag_emlrtRTEI, true);
  st.site = &ai_emlrtRSI;
  i = b_x->size[0];
  b_x->size[0] = x->size[0];
  emxEnsureCapacity_boolean_T(&st, b_x, i, &ag_emlrtRTEI);
  loop_ub = x->size[0];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(&b_st, &y, 2, &jg_emlrtRTEI, true);
  ...
  if (xLen < 1.0) {
    ...
    emxEnsureCapacity_real_T(sp, y, i, &vb_emlrtRTEI);
  ...
  if (nz < 0) {
    emlrtNonNegativeCheckR2012b(nz, &m_emlrtDCI, (emlrtCTX)sp);
  }

  emxInit_real_T(sp, &ranks, 1, &bg_emlrtRTEI, true);
  i = ranks->size[0];
  ranks->size[0] = y->size[1] + nz;
  emxEnsureCapacity_real_T(sp, ranks, i, &bg_emlrtRTEI);
  loop_ub = y->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  if (1.0 > xLen - 1.0) {
    ...
    if (1 > tieloc->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, tieloc->size[0], &jk_emlrtBCI,
        (emlrtCTX)sp);
    }
  ...
  iv[1] = loop_ub;
  st.site = &bi_emlrtRSI;
  indexShapeCheck(&st, tieloc->size[0], iv);
  if (1.0 > xLen - 1.0) {
    i = 0;
  } else {
    if (1 > rowidx->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, rowidx->size[0], &lk_emlrtBCI,
        (emlrtCTX)sp);
    }
  ...
  iv[1] = i;
  st.site = &bi_emlrtRSI;
  indexShapeCheck(&st, rowidx->size[0], iv);
  if (loop_ub != i) {
    emlrtSizeEqCheck1DR2012b(loop_ub, i, &r_emlrtECI, (emlrtCTX)sp);
  }
  ...
  if (2.0 > xLen) {
    ...
    if (2 > tieloc->size[0]) {
      emlrtDynamicBoundsCheckR2012b(2, 1, tieloc->size[0], &nk_emlrtBCI,
        (emlrtCTX)sp);
    }
  ...
  if (2.0 > xLen) {
    ...
    if (2 > rowidx->size[0]) {
      emlrtDynamicBoundsCheckR2012b(2, 1, rowidx->size[0], &pk_emlrtBCI,
        (emlrtCTX)sp);
    }
  ...
  indexShapeCheck(&st, rowidx->size[0], iv);
  if (nz != n) {
    emlrtSizeEqCheck1DR2012b(nz, n, &s_emlrtECI, (emlrtCTX)sp);
  }

  if (loop_ub != nz) {
    emlrtSizeEqCheck1DR2012b(loop_ub, nz, &r_emlrtECI, (emlrtCTX)sp);
  }

  st.site = &ci_emlrtRSI;
  nz = b_x->size[0];
  b_x->size[0] = loop_ub;
  emxEnsureCapacity_boolean_T(&st, b_x, nz, &cg_emlrtRTEI);
  for (nz = 0; nz < loop_ub; nz++) {
    b_x->data[nz] = (tieloc->data[nz] >= tieloc->data[i + nz]);
  }

  b_st.site = &nd_emlrtRSI;
  eml_find(&b_st, b_x, ii);
  i = tieloc->size[0];
  tieloc->size[0] = ii->size[0] + 1;
  emxEnsureCapacity_real_T(sp, tieloc, i, &dg_emlrtRTEI);
  loop_ub = ii->size[0];
  ...
  tiecount = 1U;
  emxInit_real_T(sp, &b_ranks, 1, &hg_emlrtRTEI, true);
  while (tiecount < (uint32_T)tieloc->size[0]) {
    ...
    iv[1] = loop_ub;
    st.site = &di_emlrtRSI;
    indexShapeCheck(&st, ranks->size[0], iv);
    if (xLen > d) {
      nz = -1;
      n = 0;
    } else {
    ...
    emxEnsureCapacity_real_T(sp, b_ranks, i1, &hg_emlrtRTEI);
  ...
  for (i = 0; i < loop_ub; i++) {
    if ((rowidx->data[i] < 1) || (rowidx->data[i] > x->size[0])) {
      emlrtDynamicBoundsCheckR2012b(rowidx->data[i], 1, x->size[0], &wk_emlrtBCI,
        (emlrtCTX)sp);
    }
  ...
  if (ii->size[0] != ranks->size[0]) {
    emlrtSubAssignSizeCheck1dR2017a(ii->size[0], ranks->size[0], &t_emlrtECI,
      (emlrtCTX)sp);
  }
...
void unibiv(FSM_wrapperStackData *SD, const emlrtStack *sp, const
            emxArray_real_T *Y, real_T varargin_2, emxArray_real_T *fre)
{
  ...
  robscale = 1;
  if ((varargin_2 <= 0.0) || (varargin_2 >= 1.0)) {
    st.site = &eg_emlrtRSI;
    error(&st);
  }

  emxInit_real_T(sp, &bivT, 1, &de_emlrtRTEI, true);

  /*  bivT contains the frequency distribution of biv. outliers */
  i = bivT->size[0];
  bivT->size[0] = Y->size[0];
  emxEnsureCapacity_real_T(sp, bivT, i, &de_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    bivT->data[i] = 0.0;
  }

  emxInit_real_T(sp, &univT, 1, &ee_emlrtRTEI, true);

  /*  univT contains the frequency distribution of univ. outliers */
  i = univT->size[0];
  univT->size[0] = Y->size[0];
  emxEnsureCapacity_real_T(sp, univT, i, &ee_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    univT->data[i] = 0.0;
  }

  emxInit_real_T(sp, &MDbiv, 1, &fe_emlrtRTEI, true);

  /*  MDbiv= vector which contains the sum of the bivaraite Mahalanobis distances for each unit */
  i = MDbiv->size[0];
  MDbiv->size[0] = Y->size[0];
  emxEnsureCapacity_real_T(sp, MDbiv, i, &fe_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    MDbiv->data[i] = 0.0;
  }
  ...
  /*  madcoef=1; */
  emxInit_real_T(sp, &biv, 2, &if_emlrtRTEI, true);
  if (Y->size[0] < 1) {
    biv->size[0] = 1;
    biv->size[1] = 0;
  } else {
    ...
    biv->size[0] = 1;
    biv->size[1] = Y->size[0];
    emxEnsureCapacity_real_T(sp, biv, i, &vb_emlrtRTEI);
    loop_ub = Y->size[0] - 1;
    for (i = 0; i <= loop_ub; i++) {
  ...
  emxInit_real_T(sp, &seq, 1, &ge_emlrtRTEI, true);
  i = seq->size[0];
  seq->size[0] = biv->size[1];
  emxEnsureCapacity_real_T(sp, seq, i, &ge_emlrtRTEI);
  loop_ub = biv->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  i = Y->size[1];
  emxInit_real_T(sp, &y, 1, &he_emlrtRTEI, true);
  emxInit_real_T(sp, &Ys, 1, &ke_emlrtRTEI, true);
  emxInit_real_T(sp, &datax, 2, &ne_emlrtRTEI, true);
  emxInit_real_T(sp, &outy, 2, &te_emlrtRTEI, true);
  emxInit_real_T(sp, &Xs, 1, &xe_emlrtRTEI, true);
  emxInit_real_T(sp, &xrank, 1, &jf_emlrtRTEI, true);
  emxInit_real_T(sp, &yrank, 1, &kf_emlrtRTEI, true);
  emxInit_creal_T(sp, &new2, 2, &hf_emlrtRTEI, true);
  emxInit_boolean_T(sp, &r, 1, &se_emlrtRTEI, true);
  emxInit_boolean_T(sp, &r1, 1, &se_emlrtRTEI, true);
  emxInit_int32_T(sp, &r2, 1, &oe_emlrtRTEI, true);
  emxInit_int32_T(sp, &ii, 1, &se_emlrtRTEI, true);
  emxInit_real_T(sp, &r3, 1, &re_emlrtRTEI, true);
  emxInit_real_T(sp, &b_Y, 1, &ie_emlrtRTEI, true);
  emxInit_creal_T(sp, &b_Xs, 2, &gf_emlrtRTEI, true);
  for (il = 0; il < i; il++) {
    /*  il is linked to the rows */
    /*  Ys = vector which contains standardized data */
    if (il + 1 > Y->size[1]) {
      emlrtDynamicBoundsCheckR2012b(il + 1, 1, Y->size[1], &qj_emlrtBCI,
        (emlrtCTX)sp);
    }
    ...
    i1 = y->size[0];
    y->size[0] = Y->size[0];
    emxEnsureCapacity_real_T(sp, y, i1, &he_emlrtRTEI);
    i1 = b_Y->size[0];
    b_Y->size[0] = Y->size[0];
    emxEnsureCapacity_real_T(sp, b_Y, i1, &ie_emlrtRTEI);
    for (i1 = 0; i1 < loop_ub; i1++) {
    ...
    if (mady > 0.0) {
      ...
      i1 = Ys->size[0];
      Ys->size[0] = Y->size[0];
      emxEnsureCapacity_real_T(sp, Ys, i1, &ke_emlrtRTEI);
      for (i1 = 0; i1 < loop_ub; i1++) {
      ...
      if (mady > 0.0) {
        ...
        i1 = Ys->size[0];
        Ys->size[0] = Y->size[0];
        emxEnsureCapacity_real_T(sp, Ys, i1, &me_emlrtRTEI);
        for (i1 = 0; i1 < loop_ub; i1++) {
          Ys->data[i1] = (Y->data[i1 + Y->size[0] * il] - Ty) / brm;
        }
      } else {
        ...
        i1 = Ys->size[0];
        Ys->size[0] = Y->size[0];
        emxEnsureCapacity_real_T(sp, Ys, i1, &le_emlrtRTEI);
        for (i1 = 0; i1 < loop_ub; i1++) {
          Ys->data[i1] = (Y->data[i1 + Y->size[0] * il] - Ty) / brm;
        }
      }
    ...
    datax->size[1] = 2;
    emxEnsureCapacity_real_T(&b_st, datax, i1, &ne_emlrtRTEI);
    for (i1 = 0; i1 < loop_ub; i1++) {
    ...
    emxEnsureCapacity_boolean_T(sp, r, i1, &oe_emlrtRTEI);
    for (i1 = 0; i1 < loop_ub; i1++) {
    ...
    emxEnsureCapacity_boolean_T(sp, r1, i1, &pe_emlrtRTEI);
    for (i1 = 0; i1 < loop_ub; i1++) {
      r1->data[i1] = (datax->data[i1 + datax->size[0]] < mady);
    }

    if (r->size[0] != r1->size[0]) {
      emlrtSizeEqCheck1DR2012b(r->size[0], r1->size[0], &j_emlrtECI, (emlrtCTX)
        sp);
    }
    ...
    i1 = r1->size[0];
    r1->size[0] = r3->size[0];
    emxEnsureCapacity_boolean_T(sp, r1, i1, &re_emlrtRTEI);
    loop_ub = r3->size[0];
    for (i1 = 0; i1 < loop_ub; i1++) {
    ...
    i1 = r2->size[0];
    r2->size[0] = loop_ub;
    emxEnsureCapacity_int32_T(sp, r2, i1, &se_emlrtRTEI);
    loop_ub = 0;
    for (b_i = 0; b_i <= end; b_i++) {
      if (r->data[b_i] || r1->data[b_i]) {
    ...
    outy->size[1] = 2;
    emxEnsureCapacity_real_T(sp, outy, i1, &te_emlrtRTEI);
    for (i1 = 0; i1 < 2; i1++) {
    ...
    if (r2->size[0] != 0) {
      ...
      i1 = r3->size[0];
      r3->size[0] = r2->size[0];
      emxEnsureCapacity_real_T(sp, r3, i1, &ve_emlrtRTEI);
      for (i1 = 0; i1 < loop_ub; i1++) {
        if (outy->data[i1] != (int32_T)muDoubleScalarFloor(outy->data[i1])) {
          emlrtIntegerCheckR2012b(outy->data[i1], &l_emlrtDCI, (emlrtCTX)sp);
        }

        i2 = (int32_T)outy->data[i1];
        if ((i2 < 1) || (i2 > univT->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, univT->size[0], &wj_emlrtBCI,
            (emlrtCTX)sp);
        }
      ...
      if (ii->size[0] != r2->size[0]) {
        emlrtSubAssignSizeCheck1dR2017a(ii->size[0], r2->size[0], &k_emlrtECI,
          (emlrtCTX)sp);
      }
    ...
    for (jl = 0; jl < i1; jl++) {
      ...
      if ((uint32_T)(il + 1) != b_jl) {
        ...
        i2 = b_Y->size[0];
        b_Y->size[0] = Y->size[0];
        emxEnsureCapacity_real_T(sp, b_Y, i2, &we_emlrtRTEI);
        for (i2 = 0; i2 < loop_ub; i2++) {
        ...
        if (mady > 0.0) {
          ...
          i2 = Xs->size[0];
          Xs->size[0] = Y->size[0];
          emxEnsureCapacity_real_T(sp, Xs, i2, &xe_emlrtRTEI);
          for (i2 = 0; i2 < loop_ub; i2++) {
          ...
          if (robscale == 1) {
            ...
            b_disp(&st, h_emlrt_marshallOut(&st, b_cv), n_emlrt_marshallOut(&st,
                    b_cv1), &tb_emlrtMCI);
            robscale = 2;
          }
          ...
          if (mady > 0.0) {
            ...
            i2 = Xs->size[0];
            Xs->size[0] = Y->size[0];
            emxEnsureCapacity_real_T(sp, Xs, i2, &af_emlrtRTEI);
            for (i2 = 0; i2 < loop_ub; i2++) {
            ...
            b_disp(&st, h_emlrt_marshallOut(&st, b_cv4), o_emlrt_marshallOut(&st,
                    b_cv5), &vb_emlrtMCI);
          } else {
            st.site = &icb_emlrtRSI;
            b_disp(&st, h_emlrt_marshallOut(&st, b_cv2), p_emlrt_marshallOut(&st,
                    b_cv3), &ub_emlrtMCI);
            loop_ub = Y->size[0];
            i2 = b_Y->size[0];
            b_Y->size[0] = Y->size[0];
            ...
            i2 = Xs->size[0];
            Xs->size[0] = Y->size[0];
            emxEnsureCapacity_real_T(sp, Xs, i2, &cf_emlrtRTEI);
            for (i2 = 0; i2 < loop_ub; i2++) {
              Xs->data[i2] = (Y->data[i2 + Y->size[0] * ((int32_T)b_jl - 1)] -
                              Ty) / brm;
            }
        ...
        if (robscale == 1) {
          if (Xs->size[0] != Ys->size[0]) {
            emlrtSizeEqCheck1DR2012b(Xs->size[0], Ys->size[0], &l_emlrtECI,
              (emlrtCTX)sp);
          }

          i2 = b_Y->size[0];
          b_Y->size[0] = Xs->size[0];
          emxEnsureCapacity_real_T(sp, b_Y, i2, &ye_emlrtRTEI);
          loop_ub = Xs->size[0];
          for (i2 = 0; i2 < loop_ub; i2++) {
          ...
          b_abs(&st, b_Y, xrank);
          if (Xs->size[0] != Ys->size[0]) {
            emlrtSizeEqCheck1DR2012b(Xs->size[0], Ys->size[0], &m_emlrtECI,
              (emlrtCTX)sp);
          }

          i2 = b_Y->size[0];
          b_Y->size[0] = Xs->size[0];
          emxEnsureCapacity_real_T(sp, b_Y, i2, &df_emlrtRTEI);
          loop_ub = Xs->size[0];
          for (i2 = 0; i2 < loop_ub; i2++) {
            b_Y->data[i2] = Xs->data[i2] - Ys->data[i2];
          }
          ...
          emxEnsureCapacity_real_T(sp, r3, i2, &bf_emlrtRTEI);
          ...
          emxEnsureCapacity_real_T(&st, b_Y, i2, &ef_emlrtRTEI);
          ...
          b_dynamic_size_checks(&b_st, r3, b_Y, r3->size[0], b_Y->size[0]);
          st.site = &kf_emlrtRSI;
        ...
        if (yrank->size[0] != r3->size[0]) {
          emlrtSizeEqCheck1DR2012b(yrank->size[0], r3->size[0], &n_emlrtECI,
            (emlrtCTX)sp);
        }
        ...
        emxEnsureCapacity_real_T(sp, xrank, i2, &ff_emlrtRTEI);
        loop_ub = Xs->size[0];
        for (i2 = 0; i2 < loop_ub; i2++) {
        ...
        if (xrank->size[0] != Ys->size[0]) {
          emlrtSizeEqCheck1DR2012b(xrank->size[0], Ys->size[0], &o_emlrtECI,
            (emlrtCTX)sp);
        }
        ...
        if (yrank->size[0] != xrank->size[0]) {
          emlrtSizeEqCheck1DR2012b(yrank->size[0], xrank->size[0], &n_emlrtECI,
            (emlrtCTX)sp);
        }
        ...
        if (MDbiv->size[0] != yrank->size[0]) {
          emlrtSizeEqCheck1DR2012b(MDbiv->size[0], yrank->size[0], &p_emlrtECI,
            (emlrtCTX)sp);
        }
        ...
        median(&st, yrank);
        st.site = &hf_emlrtRSI;
        Ty = 2.0 * ((real_T)n - 1.0) / ((real_T)n - 2.0) * finv(&st, varargin_2,
          (real_T)n - 2.0);
        st.site = &gf_emlrtRSI;
        if (Ty < 0.0) {
        ...
        emxEnsureCapacity_creal_T(sp, b_Xs, i2, &gf_emlrtRTEI);
        loop_ub = Xs->size[0];
        for (i2 = 0; i2 < loop_ub; i2++) {
        ...
        emxEnsureCapacity_creal_T(sp, new2, i2, &hf_emlrtRTEI);
        loop_ub = b_Xs->size[1];
        for (i2 = 0; i2 < 2; i2++) {
        ...
        biv->size[0] = 1;
        biv->size[1] = n;
        emxEnsureCapacity_real_T(sp, biv, i2, &if_emlrtRTEI);
        for (i2 = 0; i2 < n; i2++) {
          biv->data[i2] = 0.0;
        }
        ...
        if (bivT->size[0] != biv->size[1]) {
          emlrtSizeEqCheck1DR2012b(bivT->size[0], biv->size[1], &q_emlrtECI,
            (emlrtCTX)sp);
        }
  ...
  fre->size[1] = 4;
  emxEnsureCapacity_real_T(&b_st, fre, i, &je_emlrtRTEI);
  loop_ub = seq->size[0];
  for (i = 0; i < loop_ub; i++) {
