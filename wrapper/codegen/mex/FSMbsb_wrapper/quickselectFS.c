                     ...
                     real_T kiniindex)
{
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &kc_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &mc_emlrtBCI,
                                  (emlrtCTX)sp);
  }
  ...
  while (Ak != k) {
    ...
    if ((right < 1) || (right > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &qc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &rc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    A->data[(int32_T)k - 1] = A->data[right - 1];
    if (right > A->size[0]) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &sc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    for (b_i = 0; b_i <= i; b_i++) {
      ...
      if (((int32_T)c_i < 1) || ((int32_T)c_i > A->size[0])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)c_i, 1, A->size[0], &vc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    ...
    if (((int32_T)Ak < 1) || ((int32_T)Ak > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)Ak, 1, A->size[0], &tc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if (right > A->size[0]) {
      emlrtDynamicBoundsCheckR2012b(right, 1, A->size[0], &uc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    A->data[right - 1] = A->data[(int32_T)Ak - 1];
    if (((int32_T)Ak < 1) || ((int32_T)Ak > A->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)Ak, 1, A->size[0], &wc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  if (((int32_T)k < 1) || ((int32_T)k > A->size[0])) {
    emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, A->size[0], &oc_emlrtBCI,
                                  (emlrtCTX)sp);
  }
