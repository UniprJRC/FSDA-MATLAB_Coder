...
void b_warning(const emlrtStack *sp, const char_T varargin_1[14])
{
  ...
  emlrtAssign(&d_y, m);
  st.site = &el_emlrtRSI;
  d_feval(&st, y, feval(&st, b_y, c_y, d_y, &n_emlrtMCI), &o_emlrtMCI);
}
               ...
               const char_T varargin_2[14])
{
  ...
  *(int32_T *)emlrtMxGetData(m) = varargin_1;
  ...
  emlrtAssign(&e_y, m);
  st.site = &el_emlrtRSI;
  d_feval(&st, y, b_feval(&st, b_y, c_y, d_y, e_y, &n_emlrtMCI), &o_emlrtMCI);
}
...
void warning(const emlrtStack *sp)
{
  ...
  emlrtAssign(&c_y, m);
  st.site = &el_emlrtRSI;
  d_feval(&st, y, c_feval(&st, b_y, c_y, &n_emlrtMCI), &o_emlrtMCI);
}
