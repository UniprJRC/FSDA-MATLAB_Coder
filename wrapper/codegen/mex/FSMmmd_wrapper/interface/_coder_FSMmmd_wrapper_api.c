 ...
 *
 * _coder_FSMmmd_wrapper_api.c
 *
 * Code generation for function '_coder_FSMmmd_wrapper_api'
 *
 */
...
static emlrtRTEInfo mi_emlrtRTEI = {
    1,                           /* lineNo */
    1,                           /* colNo */
    "_coder_FSMmmd_wrapper_api", /* fName */
    ""                           /* pName */
};
                        ...
                        const mxArray *plhs[3])
{
  ...
  emxInit_real_T(&st, &Y, 2, &mi_emlrtRTEI, true);
  emxInit_real_T(&st, &bsb, 1, &mi_emlrtRTEI, true);
  emxInit_real_T(&st, &bsbsteps, 2, &mi_emlrtRTEI, true);
  emxInit_real_T(&st, &mmd, 2, &mi_emlrtRTEI, true);
  emxInit_real_T(&st, &Un, 2, &mi_emlrtRTEI, true);
  emxInit_real_T(&st, &BB, 2, &mi_emlrtRTEI, true);
  ...
  FSMmmd_wrapper(&st, Y, bsb, bsbsteps, init, msg, nocheck, mmd, Un, BB);
  /* Marshall function outputs */
  mmd->canFreeData = false;
  plhs[0] = o_emlrt_marshallOut(mmd);
  emxFree_real_T(&mmd);
  ...
  if (nlhs > 1) {
    ...
    plhs[1] = o_emlrt_marshallOut(Un);
  }
  emxFree_real_T(&Un);
  if (nlhs > 2) {
    BB->canFreeData = false;
    plhs[2] = o_emlrt_marshallOut(BB);
  }
  emxFree_real_T(&BB);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

/* End of code generation (_coder_FSMmmd_wrapper_api.c) */
