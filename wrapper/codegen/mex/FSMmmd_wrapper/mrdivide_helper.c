           ...
           const emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &yh_emlrtRTEI, true);
  emxInit_int32_T(sp, &ipiv, 2, &ai_emlrtRTEI, true);
  emxInit_ptrdiff_t(sp, &ipiv_t, 1, &kh_emlrtRTEI, true);
  emxInit_ptrdiff_t(sp, &r, 1, &fh_emlrtRTEI, true);
  emxInit_real_T(sp, &b_B, 2, &uh_emlrtRTEI, true);
  emxInit_real_T(sp, &c_A, 2, &wh_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) ||
      ((B->size[0] == 0) || (B->size[1] == 0))) {
    i = Y->size[0] * Y->size[1];
    Y->size[0] = A->size[0];
    Y->size[1] = B->size[0];
    emxEnsureCapacity_real_T(sp, Y, i, &th_emlrtRTEI);
    ...
    Y->size[0] = A->size[0];
    Y->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, Y, i, &vh_emlrtRTEI);
    ...
    b_A->size[0] = B->size[0];
    b_A->size[1] = B->size[1];
    emxEnsureCapacity_real_T(&d_st, b_A, i, &eh_emlrtRTEI);
    ...
    emxEnsureCapacity_ptrdiff_t(&e_st, ipiv_t, i, &fh_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(&e_st, ipiv, i, &gh_emlrtRTEI);
    ...
    b_B->size[0] = B->size[1];
    b_B->size[1] = B->size[0];
    emxEnsureCapacity_real_T(sp, b_B, i, &uh_emlrtRTEI);
    loop_ub = B->size[0];
    for (i = 0; i < loop_ub; i++) {
      n = B->size[1];
      for (i1 = 0; i1 < n; i1++) {
    ...
    c_A->size[0] = A->size[1];
    c_A->size[1] = A->size[0];
    emxEnsureCapacity_real_T(sp, c_A, i, &wh_emlrtRTEI);
    loop_ub = A->size[0];
    for (i = 0; i < loop_ub; i++) {
      n = A->size[1];
      for (i1 = 0; i1 < n; i1++) {
