...
static emlrtMCInfo t_emlrtMCI = { 264, /* lineNo */
  13,                                  /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};

static emlrtMCInfo u_emlrtMCI = { 352, /* lineNo */
  9,                                   /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};

static emlrtMCInfo v_emlrtMCI = { 434, /* lineNo */
  9,                                   /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};

static emlrtMCInfo w_emlrtMCI = { 437, /* lineNo */
  5,                                   /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};

static emlrtMCInfo x_emlrtMCI = { 582, /* lineNo */
  21,                                  /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};

static emlrtMCInfo y_emlrtMCI = { 584, /* lineNo */
  17,                                  /* colNo */
  "FSMmmd",                            /* fName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pName */
};
...
static emlrtRSInfo vmb_emlrtRSI = { 437,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};

static emlrtRSInfo wmb_emlrtRSI = { 584,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};

static emlrtRSInfo fnb_emlrtRSI = { 434,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};

static emlrtRSInfo gnb_emlrtRSI = { 582,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};

static emlrtRSInfo hnb_emlrtRSI = { 264,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};

static emlrtRSInfo aob_emlrtRSI = { 352,/* lineNo */
  "FSMmmd",                            /* fcnName */
  "D:\\MATLAB\\FSDAgit\\FSDA\\multivariate\\FSMmmd.m"/* pathName */
};
            ...
            emxArray_real_T *varargout_1)
{
  ...
  if (b_ifWhileCond(&st, bsbT)) {
    ...
    if (nwhile == 100) {
      ...
      b_disp(&st, e_emlrt_marshallOut(&st, cv3), y_emlrt_marshallOut(&st, cv4),
             &t_emlrtMCI);
    }
  }
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if ((k < 1) || (k > Y->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &ym_emlrtBCI, (emlrtCTX)sp);
    }
  ...
  if (varargin_2 < (real_T)Y->size[1] + 1.0) {
    ...
    g_emlrt_marshallIn(&c_st, d_feval(&c_st, g_emlrt_marshallOut(&c_st, b_cv),
      ...
      w_emlrt_marshallOut(&e_st, cv6), &ab_emlrtMCI), "<output of feval>");
    init1 = (real_T)Y->size[1] + 1.0;
  } else if (varargin_2 < bsb->size[0]) {
    st.site = &aob_emlrtRSI;
    disp(&st, ab_emlrt_marshallOut(&st, cv5), &u_emlrtMCI);
    init1 = bsb->size[0];
    ...
    g_emlrt_marshallIn(&c_st, d_feval(&c_st, g_emlrt_marshallOut(&c_st, b_cv),
      i_emlrt_marshallOut(1.0), h_emlrt_marshallOut(&d_st, b_cv1),
      x_emlrt_marshallOut(&e_st, cv7), &ab_emlrtMCI), "<output of feval>");
  ...
  for (i = 0; i < loop_ub; i++) {
    k = (int32_T)bsb->data[i];
    if ((k < 1) || (k > Y->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &an_emlrtBCI, &st);
    }
  }
  ...
  if (irank < v) {
    ...
    for (i = 0; i < loop_ub; i++) {
      k = (int32_T)bsb->data[i];
      if ((k < 1) || (k > Y->size[0])) {
        emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &bn_emlrtBCI, &st);
      }
    }
    ...
    for (i = 0; i < loop_ub; i++) {
      k = (int32_T)bsb->data[i];
      if ((k < 1) || (k > Y->size[0])) {
        emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &cn_emlrtBCI, &st);
      }
    }
    ...
    f_st.site = &nb_emlrtRSI;
    if (mibsbr->size[1] < 1) {
      emlrtErrorWithMessageIdR2018a(&f_st, &lb_emlrtRTEI,
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                if ((k < 1) || (k > varargout_1->size[0])) {
                  emlrtDynamicBoundsCheckR2012b((int32_T)bsb->data[i], 1,
                    varargout_1->size[0], &in_emlrtBCI, (emlrtCTX)sp);
                }
        ...
        if (b_mm - (real_T)lunit > (real_T)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              if ((k < 1) || (k > Y->size[0])) {
                emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &ln_emlrtBCI,
                  &st);
              }
            }
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              for (i = 0; i < loop_ub; i++) {
                k = bsbr->data[i];
                if ((k < 1) || (k > Y->size[0])) {
                  emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &pn_emlrtBCI,
                    &st);
                }
              }
            ...
            if (unitout->size[0] > 1) {
              ...
              for (b_i = 0; b_i < i; b_i++) {
                ...
                if ((k < 1) || (k > Y->size[0])) {
                  emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &lm_emlrtBCI,
                    (emlrtCTX)sp);
                }
          ...
          if (lunit > 1) {
            ...
            for (b_i = 0; b_i < lunit; b_i++) {
              ...
              i = unit->data[b_i];
              if ((i < 1) || (i > Y->size[0])) {
                emlrtDynamicBoundsCheckR2012b(i, 1, Y->size[0], &mm_emlrtBCI,
                  (emlrtCTX)sp);
              }
          ...
          if (b_mm > percn) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              for (k = 0; k < irank; k++) {
                ...
                {
                  emlrtDynamicBoundsCheckR2012b((int32_T)bsb->data[k], 1,
                    Ym->size[0], &jn_emlrtBCI, (emlrtCTX)sp);
                }
          ...
          if (irank > 0) {
            ...
            b_disp(&st, e_emlrt_marshallOut(&st, cv3), r_emlrt_marshallOut(&st,
                    cv10), &x_emlrtMCI);
            st.site = &wmb_emlrtRSI;
            disp(&st, b_emlrt_marshallOut(&st, cv9), &y_emlrtMCI);
            i = mmd->size[0] * mmd->size[1];
            mmd->size[0] = 1;
            mmd->size[1] = 1;
          ...
          if (b_mm < n) {
            ...
            if (b_mm > percn) {
              ...
              for (i = 0; i < loop_ub; i++) {
                ...
                if ((k < 1) || (k > MD->size[0])) {
                  emlrtDynamicBoundsCheckR2012b((int32_T)bsb->data[i], 1,
                    MD->size[0], &qn_emlrtBCI, (emlrtCTX)sp);
                }
            ...
            if (rankgap == 1.0) {
                ...
                for (i = 0; i < loop_ub; i++) {
                  if (((int32_T)bsbrini->data[i] < 1) || ((int32_T)bsbrini->
                    ...
                    emlrtDynamicBoundsCheckR2012b((int32_T)bsbrini->data[i], 1,
                      MD->size[0], &do_emlrtBCI, (emlrtCTX)sp);
                  }
              ...
              for (loop_ub = 0; loop_ub < i; loop_ub++) {
                ...
                if (bsbT->data[idx - 1]) {
                  if (b_mm <= percn) {
                    if ((zz + 1 < 1) || (zz + 1 > 10)) {
                      emlrtDynamicBoundsCheckR2012b(zz + 1, 1, 10, &pm_emlrtBCI,
                        (emlrtCTX)sp);
                    }
                      ...
                      if ((int32_T)unitout->data[b_i] != idx) {
                        if (b_i + 1 > unitout->size[0]) {
                          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1,
                            unitout->size[0], &lo_emlrtBCI, (emlrtCTX)sp);
                        }
                  ...
                  if ((lunit + 1 < 1) || (lunit + 1 > 10)) {
                    emlrtDynamicBoundsCheckR2012b(lunit + 1, 1, 10, &nm_emlrtBCI,
                      (emlrtCTX)sp);
                  }
              ...
              if (1 > lunit) {
                ...
                emlrtDynamicBoundsCheckR2012b(lunit, 1, 10, &om_emlrtBCI,
                  (emlrtCTX)sp);
              }
              ...
              if (b_mm <= percn) {
                if (1 > zz) {
                  ...
                  emlrtDynamicBoundsCheckR2012b(zz, 1, 10, &qm_emlrtBCI,
                    (emlrtCTX)sp);
                }
              ...
              if (irank == (int32_T)b_mm + 1) {
                ...
                if (1.0 > d) {
                  ...
                  if (1 > trueCount) {
                    emlrtDynamicBoundsCheckR2012b(1, 1, trueCount, &rm_emlrtBCI,
                      (emlrtCTX)sp);
                  }
  ...
  if (guard1) {
    ...
    disp(&st, b_emlrt_marshallOut(&st, cv9), &w_emlrtMCI);
    i = mmd->size[0] * mmd->size[1];
    mmd->size[0] = 1;
    mmd->size[1] = 1;
