                             ...
                             const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_real_T(sp, &pStruct->mdr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Un, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->nout, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->beta, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->mdag, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->ListCl, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->VIOMout, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->fittedvalues, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->residuals, 2, srcLocation, doPush);
}
...
/* End of code generation (FSR_wrapper_emxutil.c) */
