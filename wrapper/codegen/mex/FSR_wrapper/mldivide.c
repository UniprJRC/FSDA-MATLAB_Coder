              ...
              const emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  if (B->size[0] != A->size[0]) {
    emlrtErrorWithMessageIdR2018a(sp, &qc_emlrtRTEI, "MATLAB:dimagree",
                                  "MATLAB:dimagree", 0);
  }
  st.site = &jeb_emlrtRSI;
  emxInit_real_T(&st, &b_A, 2, &tx_emlrtRTEI, true);
  emxInit_real_T(&st, &tau, 1, &tx_emlrtRTEI, true);
  emxInit_int32_T(&st, &jpvt, 2, &tx_emlrtRTEI, true);
  emxInit_real_T(&st, &b_B, 1, &px_emlrtRTEI, true);
  emxInit_ptrdiff_t(&st, &IPIV, 1, &ux_emlrtRTEI, true);
  emxInit_ptrdiff_t(&st, &r, 1, &rx_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    i = Y->size[0];
    Y->size[0] = A->size[1];
    emxEnsureCapacity_real_T(&st, Y, i, &nx_emlrtRTEI);
    na = A->size[1];
    for (i = 0; i < na; i++) {
      Y->data[i] = 0.0;
    }
    ...
    i = Y->size[0];
    Y->size[0] = B->size[0];
    emxEnsureCapacity_real_T(&c_st, Y, i, &nx_emlrtRTEI);
    na = B->size[0];
    for (i = 0; i < na; i++) {
      Y->data[i] = B->data[i];
    }
    d_st.site = &meb_emlrtRSI;
    e_st.site = &neb_emlrtRSI;
    ma = A->size[0];
    na = A->size[1];
    mb = B->size[0];
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&f_st, b_A, i, &qx_emlrtRTEI);
    ...
    emxEnsureCapacity_ptrdiff_t(&f_st, IPIV, i, &rx_emlrtRTEI);
    nrc_t = (ptrdiff_t)ma;
    ...
    if (ma < 0) {
      if (ma == -1010) {
        ...
        emlrtErrorWithMessageIdR2018a(
            &g_st, &q_emlrtRTEI, "Coder:toolbox:LAPACKCallErrorInfo",
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, b_A, i, &ox_emlrtRTEI);
    na = A->size[0] * A->size[1];
    for (i = 0; i < na; i++) {
      b_A->data[i] = A->data[i];
    }
    ...
    i = b_B->size[0];
    b_B->size[0] = B->size[0];
    emxEnsureCapacity_real_T(&c_st, b_B, i, &px_emlrtRTEI);
    na = B->size[0];
    for (i = 0; i < na; i++) {
      b_B->data[i] = B->data[i];
    }
    ...
    if ((b_A->size[0] != 0) && (b_A->size[1] != 0)) {
      ...
      nrc_t = LAPACKE_dormqr(
          ...
          nrc_t);
      f_st.site = &dab_emlrtRSI;
      if (infocheck(&f_st, (int32_T)nrc_t)) {
        ma = b_B->size[0];
        i = b_B->size[0];
        b_B->size[0] = ma;
        emxEnsureCapacity_real_T(&e_st, b_B, i, &sx_emlrtRTEI);
        for (i = 0; i < ma; i++) {
          b_B->data[i] = rtNaN;
        }
      }
