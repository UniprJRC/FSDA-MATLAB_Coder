                                   ...
                                   boolean_T doPush)
{
  ...
  emxInit_cell_wrap_0(sp, &pStruct->Un, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->y, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->X, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Scorep, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Scoren, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Scoreb, 2, srcLocation, doPush);
}
