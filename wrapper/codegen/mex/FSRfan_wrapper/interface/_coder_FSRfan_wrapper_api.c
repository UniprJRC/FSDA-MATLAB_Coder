...
void FSRfan_wrapper_api(const mxArray *const prhs[11], const mxArray **plhs)
{
  ...
  emxInit_real_T(&st, &y, 1, &hl_emlrtRTEI, true);
  emxInit_real_T(&st, &X, 2, &hl_emlrtRTEI, true);
  emxInit_real_T(&st, &la, 1, &hl_emlrtRTEI, true);
  emxInit_real_T(&st, &lms, 2, &hl_emlrtRTEI, true);
  emxInit_char_T(&st, &family, 2, &hl_emlrtRTEI, true);
  emxInitStruct_struct_FSRfan_T(&st, &out, &hl_emlrtRTEI, true);
