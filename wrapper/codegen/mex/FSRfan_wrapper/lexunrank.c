...
void b_lexunrank(const emlrtStack *sp, real_T n, real_T k, real_T N,
  ...
  for (kk = 0; kk < i; kk++) {
    ...
    if (b_kk == k) {
      ...
      if (ii_data != b_y->size[0]) {
        emlrtSubAssignSizeCheck1dR2017a(ii_data, b_y->size[0], &j_emlrtECI,
                                        (emlrtCTX)sp);
      }
      for (i1 = 0; i1 < ii_data; i1++) {
...
void lexunrank(const emlrtStack *sp, real_T n, real_T k, real_T N,
               const emxArray_real_T *pascalM, emxArray_real_T *kcomb)
{
  emlrtStack b_st;
  emlrtStack st;
  ...
  N_kk = N;
  i = (int32_T)(((-1.0 - k) + 1.0) / -1.0);
  emlrtForLoopVectorCheckR2021a(k, -1.0, 1.0, mxDOUBLE_CLASS, i, &bb_emlrtRTEI,
                                (emlrtCTX)sp);
  for (kk = 0; kk < i; kk++) {
    b_kk = k + -(real_T)kk;
    ...
    if (1.0 > maxx) {
      ...
      if (1 > pascalM->size[0]) {
        emlrtDynamicBoundsCheckR2012b(1, 1, pascalM->size[0], &fc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (((int32_T)maxx < 1) || ((int32_T)maxx > pascalM->size[0])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)maxx, 1, pascalM->size[0],
    ...
    pascalM_size = ii_data;
    for (ii_size = 0; ii_size < ii_data; ii_size++) {
      b_pascalM_data[ii_size] =
          (pascalM->data[ii_size + pascalM->size[0] *
                                       ((int32_T)(b_kk + 1.0) - 1)] > N_kk);
    }
    ...
    kcomb->data[(int32_T)b_kk - 1] = n - maxx;
    if (maxx >= b_kk) {
      ii_size = (int32_T)((maxx - b_kk) + 1.0);
      if ((ii_size < 1) || (ii_size > pascalM->size[0])) {
        emlrtDynamicBoundsCheckR2012b(ii_size, 1, pascalM->size[0],
                                      &jc_emlrtBCI, (emlrtCTX)sp);
      }
      if (((int32_T)(b_kk + 1.0) < 1) ||
          ((int32_T)(b_kk + 1.0) > pascalM->size[1])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)(b_kk + 1.0), 1,
                                      pascalM->size[1], &jc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      N_kk -= pascalM->data[(ii_size +
                             pascalM->size[0] * ((int32_T)(b_kk + 1.0) - 1)) -
                            1];
