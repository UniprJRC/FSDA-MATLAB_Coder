              ...
              const emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  st.site = &uf_emlrtRSI;
  emxInit_real_T(&st, &b_A, 2, &cg_emlrtRTEI, true);
  emxInit_real_T(&st, &tau, 1, &cg_emlrtRTEI, true);
  emxInit_int32_T(&st, &jpvt, 2, &cg_emlrtRTEI, true);
  emxInit_real_T(&st, &b_B, 1, &xf_emlrtRTEI, true);
  emxInit_ptrdiff_t(&st, &IPIV, 1, &dg_emlrtRTEI, true);
  emxInit_ptrdiff_t(&st, &r, 1, &ag_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    i = Y->size[0];
    Y->size[0] = A->size[1];
    emxEnsureCapacity_real_T(&st, Y, i, &vf_emlrtRTEI);
    na = A->size[1];
    for (i = 0; i < na; i++) {
      Y->data[i] = 0.0;
    }
    ...
    i = Y->size[0];
    Y->size[0] = B->size[0];
    emxEnsureCapacity_real_T(&c_st, Y, i, &vf_emlrtRTEI);
    na = B->size[0];
    for (i = 0; i < na; i++) {
      Y->data[i] = B->data[i];
    }
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&f_st, b_A, i, &yf_emlrtRTEI);
    ...
    emxEnsureCapacity_ptrdiff_t(&f_st, IPIV, i, &ag_emlrtRTEI);
    nrc_t = (ptrdiff_t)ma;
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = A->size[1];
    emxEnsureCapacity_real_T(&b_st, b_A, i, &wf_emlrtRTEI);
    na = A->size[0] * A->size[1];
    for (i = 0; i < na; i++) {
      b_A->data[i] = A->data[i];
    }
    ...
    i = b_B->size[0];
    b_B->size[0] = B->size[0];
    emxEnsureCapacity_real_T(&c_st, b_B, i, &xf_emlrtRTEI);
    na = B->size[0];
    for (i = 0; i < na; i++) {
      b_B->data[i] = B->data[i];
    }
    ...
    if ((b_A->size[0] != 0) && (b_A->size[1] != 0)) {
      ...
      if (infocheck(&f_st, (int32_T)nrc_t)) {
        ...
        i = b_B->size[0];
        b_B->size[0] = ma;
        emxEnsureCapacity_real_T(&e_st, b_B, i, &bg_emlrtRTEI);
        for (i = 0; i < ma; i++) {
          b_B->data[i] = rtNaN;
        }
      }
