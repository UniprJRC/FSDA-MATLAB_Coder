               ...
               const char_T varargin_2[14])
{
  ...
  *(int32_T *)emlrtMxGetData(m) = varargin_1;
  ...
  c_feval(&st, y, d_feval(&st, b_y, c_y, d_y, e_y, &n_emlrtMCI), &o_emlrtMCI);
}
...
void d_warning(const emlrtStack *sp, const char_T varargin_2[12])
{
  ...
  static const char_T msgID[26] = {'s', 't', 'a', 't', 's', ':', 'g', 'a', 'm',
                                   'i', 'n', 'v', ':', 'N', 'o', 'C', 'o', 'n',
                                   'v', 'e', 'r', 'g', 'e', 'n', 'c', 'e'};
  static const char_T varargin_1[12] = {' ', ' ', '5', '.', '0', '0',
                                        '0', '0', 'e', '-', '0', '1'};
  static const char_T varargin_3[12] = {' ', ' ', '9', '.', '9', '0',
                                        '0', '0', 'e', '-', '0', '1'};
  static const char_T b_u[7] = {'m', 'e', 's', 's', 'a', 'g', 'e'};
  static const char_T u[7] = {'w', 'a', 'r', 'n', 'i', 'n', 'g'};
  emlrtStack st;
  ...
  emlrtAssign(&f_y, m);
  st.site = &ueb_emlrtRSI;
  c_feval(&st, y, e_feval(&st, b_y, c_y, d_y, e_y, f_y, &n_emlrtMCI),
          &o_emlrtMCI);
}
...
void e_warning(const emlrtStack *sp, const char_T varargin_1[14])
{
  ...
  emlrtAssign(&d_y, m);
  st.site = &ueb_emlrtRSI;
  c_feval(&st, y, feval(&st, b_y, c_y, d_y, &n_emlrtMCI), &o_emlrtMCI);
}
...
void f_warning(const emlrtStack *sp)
{
  ...
  emlrtAssign(&c_y, m);
  st.site = &ueb_emlrtRSI;
  c_feval(&st, y, b_feval(&st, b_y, c_y, &n_emlrtMCI), &o_emlrtMCI);
}
