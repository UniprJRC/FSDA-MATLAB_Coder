            ...
            emxArray_real_T *Un, emxArray_real_T *BB)
{
  ...
  emxInit_boolean_T(sp, &bsbT, 1, &cs_emlrtRTEI, true);
  ...
  emxEnsureCapacity_boolean_T(sp, bsbT, i, &yr_emlrtRTEI);
  loop_ub = bsb->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbT->data[i] = (bsb->data[i] == 0.0);
  }
  emxInit_real_T(sp, &Yb, 2, &at_emlrtRTEI, true);
  emxInit_real_T(sp, &b_Y, 2, &vs_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &ym, 2, &dt_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &seq, 1, &kv_emlrtRTEI, true);
  i = seq->size[0];
  seq->size[0] = ym->size[1];
  emxEnsureCapacity_real_T(sp, seq, i, &bs_emlrtRTEI);
  loop_ub = ym->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_boolean_T(sp, bsbT, i, &cs_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbT->data[i] = false;
  }
  ...
  emxEnsureCapacity_int32_T(sp, ii, i, &ds_emlrtRTEI);
  loop_ub = bsb->size[0];
  for (i = 0; i < loop_ub; i++) {
    k = (int32_T)bsb->data[i];
    if ((k < 1) || (k > Y->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &yq_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ii->data[i] = k;
  }
  ...
  emxInit_real_T(sp, &S, 2, &es_emlrtRTEI, true);
  /*  Initialization for Matlab coder */
  rankgap = 0.0;
  i = S->size[0] * S->size[1];
  S->size[0] = Y->size[1];
  S->size[1] = Y->size[1];
  emxEnsureCapacity_real_T(sp, S, i, &es_emlrtRTEI);
  loop_ub = Y->size[1] * Y->size[1];
  for (i = 0; i < loop_ub; i++) {
    S->data[i] = 0.0;
  }
  emxInit_real_T(sp, &meoldbsb, 2, &fs_emlrtRTEI, true);
  i = meoldbsb->size[0] * meoldbsb->size[1];
  meoldbsb->size[0] = 1;
  meoldbsb->size[1] = Y->size[1];
  emxEnsureCapacity_real_T(sp, meoldbsb, i, &fs_emlrtRTEI);
  loop_ub = Y->size[1];
  for (i = 0; i < loop_ub; i++) {
    meoldbsb->data[i] = 0.0;
  }
  emxInit_boolean_T(sp, &oldbsbT, 1, &gs_emlrtRTEI, true);
  i = oldbsbT->size[0];
  oldbsbT->size[0] = bsbT->size[0];
  emxEnsureCapacity_boolean_T(sp, oldbsbT, i, &gs_emlrtRTEI);
  loop_ub = bsbT->size[0];
  for (i = 0; i < loop_ub; i++) {
    oldbsbT->data[i] = bsbT->data[i];
  }
  emxInit_int32_T(sp, &bsbr, 1, &hs_emlrtRTEI, true);
  i = bsbr->size[0];
  bsbr->size[0] = Y->size[0];
  emxEnsureCapacity_int32_T(sp, bsbr, i, &hs_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbr->data[i] = 0;
  }
  emxInit_real_T(sp, &unitout, 1, &is_emlrtRTEI, true);
  i = unitout->size[0];
  unitout->size[0] = Y->size[0];
  emxEnsureCapacity_real_T(sp, unitout, i, &is_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    unitout->data[i] = 0.0;
  }
  emxInit_boolean_T(sp, &bsbriniT, 1, &js_emlrtRTEI, true);
  i = bsbriniT->size[0];
  bsbriniT->size[0] = bsbT->size[0];
  emxEnsureCapacity_boolean_T(sp, bsbriniT, i, &js_emlrtRTEI);
  loop_ub = bsbT->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbriniT->data[i] = bsbT->data[i];
  }
  emxInit_uint32_T(sp, &bsbrini, 1, &ks_emlrtRTEI, true);
  i = bsbrini->size[0];
  bsbrini->size[0] = Y->size[0];
  emxEnsureCapacity_uint32_T(sp, bsbrini, i, &ks_emlrtRTEI);
  loop_ub = Y->size[0];
  for (i = 0; i < loop_ub; i++) {
    bsbrini->data[i] = 0U;
  }
  ...
  emxInit_real_T(sp, &MD, 1, &ov_emlrtRTEI, true);
  emxInit_real_T(sp, &bsbsteps, 2, &qv_emlrtRTEI, true);
  if (varargin_2 == 0.0) {
    ...
    if (muDoubleScalarIsNaN(init1)) {
      ...
      ym->size[0] = 1;
      ym->size[1] = 1;
      emxEnsureCapacity_real_T(&b_st, ym, i, &ls_emlrtRTEI);
      ym->data[0] = rtNaN;
    ...
    i = MD->size[0];
    MD->size[0] = ym->size[1];
    emxEnsureCapacity_real_T(sp, MD, i, &ns_emlrtRTEI);
    loop_ub = ym->size[1];
    for (i = 0; i < loop_ub; i++) {
      MD->data[i] = ym->data[i];
    }
    ...
    bsbsteps->size[1] = 1;
    emxEnsureCapacity_real_T(sp, bsbsteps, i, &ps_emlrtRTEI);
    loop_ub = ym->size[1];
    for (i = 0; i < loop_ub; i++) {
    ...
    BB->size[0] = Y->size[0];
    emxEnsureCapacity_real_T(sp, BB, i, &qs_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, bsbsteps, i, &ms_emlrtRTEI);
    ...
    BB->size[0] = Y->size[0];
    BB->size[1] = irank;
    emxEnsureCapacity_real_T(sp, BB, i, &os_emlrtRTEI);
  ...
  i = MD->size[0];
  MD->size[0] = ym->size[1];
  emxEnsureCapacity_real_T(sp, MD, i, &rs_emlrtRTEI);
  loop_ub = ym->size[1];
  for (i = 0; i < loop_ub; i++) {
    MD->data[i] = ym->data[i];
  }
  emxInit_real_T(sp, &r, 2, &ss_emlrtRTEI, true);
  i = r->size[0] * r->size[1];
  r->size[0] = (int32_T)a;
  r->size[1] = 10;
  emxEnsureCapacity_real_T(sp, r, i, &ss_emlrtRTEI);
  loop_ub = (int32_T)a * 10;
  for (i = 0; i < loop_ub; i++) {
    r->data[i] = rtNaN;
  }
  emxInit_real_T(sp, &r1, 2, &aw_emlrtRTEI, true);
  st.site = &ldb_emlrtRSI;
  b_cat(&st, MD, r, r1);
  i = Un->size[0] * Un->size[1];
  Un->size[0] = r1->size[0];
  Un->size[1] = 11;
  emxEnsureCapacity_real_T(sp, Un, i, &ts_emlrtRTEI);
  ...
  emxFree_real_T(&r1);
  emxInit_int32_T(sp, &unit, 1, &lv_emlrtRTEI, true);
  ...
  emxEnsureCapacity_int32_T(sp, unit, i, &us_emlrtRTEI);
  loop_ub = bsb->size[0];
  for (i = 0; i < loop_ub; i++) {
    unit->data[i] = 0;
  }
  ...
  for (i = 0; i < loop_ub; i++) {
    k = (int32_T)bsb->data[i];
    if ((k < 1) || (k > Y->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &ar_emlrtBCI, &st);
    }
  }
  loop_ub = Y->size[1];
  i = b_Y->size[0] * b_Y->size[1];
  b_Y->size[0] = bsb->size[0];
  b_Y->size[1] = Y->size[1];
  emxEnsureCapacity_real_T(&st, b_Y, i, &vs_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    irank = bsb->size[0];
    for (k = 0; k < irank; k++) {
      b_Y->data[k + b_Y->size[0] * i] =
  ...
  emxInit_real_T(sp, &Ym, 2, &mv_emlrtRTEI, true);
  emxInit_real_T(sp, &mi, 2, &qt_emlrtRTEI, true);
  emxInit_real_T(sp, &mibsbr, 2, &du_emlrtRTEI, true);
  emxInit_real_T(sp, &zi, 2, &eu_emlrtRTEI, true);
  emxInit_real_T(sp, &Szi, 1, &nv_emlrtRTEI, true);
  emxInit_real_T(sp, &R, 2, &pv_emlrtRTEI, true);
  emxInit_boolean_T(sp, &MDltminT, 1, &ju_emlrtRTEI, true);
  emxInit_boolean_T(sp, &MDltminbsb, 1, &mu_emlrtRTEI, true);
  emxInit_int32_T(sp, &r2, 1, &rv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r3, 1, &sv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r4, 1, &tv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r5, 1, &uv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r6, 1, &vv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r7, 1, &wv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r8, 1, &xv_emlrtRTEI, true);
  emxInit_int32_T(sp, &r9, 1, &yv_emlrtRTEI, true);
  guard1 = false;
  if (irank < v) {
    guard1 = true;
  } else {
    ...
    for (i = 0; i < loop_ub; i++) {
      k = (int32_T)bsb->data[i];
      if ((k < 1) || (k > Y->size[0])) {
        emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &br_emlrtBCI, &st);
      }
    }
    ...
    for (i = 0; i < loop_ub; i++) {
      k = (int32_T)bsb->data[i];
      if ((k < 1) || (k > Y->size[0])) {
        emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &cr_emlrtBCI, &st);
      }
    }
    ...
    emlrtSizeEqCheckNDR2012b(&b_ym[0], &iv[0], &cc_emlrtECI, (emlrtCTX)sp);
    st.site = &kdb_emlrtRSI;
    i = mibsbr->size[0] * mibsbr->size[1];
    mibsbr->size[0] = 1;
    emxEnsureCapacity_real_T(&st, mibsbr, i, &ys_emlrtRTEI);
    ...
    if (mibsbr->size[1] < 1) {
      emlrtErrorWithMessageIdR2018a(
          &f_st, &eb_emlrtRTEI, "Coder:toolbox:eml_min_or_max_varDimZero",
    ...
    if (ksor == 0.0) {
      ...
      while ((!exitg1) && (mm <= n - ini0)) {
        ...
        if (b_mm <= percn) {
          ...
          Yb->size[1] = Y->size[1];
          emxEnsureCapacity_real_T(sp, Yb, i, &at_emlrtRTEI);
          for (i = 0; i < loop_ub; i++) {
            irank = bsb->size[0];
            for (k = 0; k < irank; k++) {
          ...
          i = r2->size[0];
          r2->size[0] = trueCount;
          emxEnsureCapacity_int32_T(sp, r2, i, &bt_emlrtRTEI);
          partialTrueCount = 0;
          for (b_i = 0; b_i <= k; b_i++) {
            if (bsbT->data[b_i]) {
          ...
          Yb->size[0] = r2->size[0];
          Yb->size[1] = Y->size[1];
          emxEnsureCapacity_real_T(sp, Yb, i, &ct_emlrtRTEI);
          for (i = 0; i < loop_ub; i++) {
            irank = r2->size[0];
            for (k = 0; k < irank; k++) {
        ...
        if (b_mm >= init1) {
          ...
          if (ifWhileCond(&st, &c_data)) {
            if (b_mm <= percn) {
              i = ii->size[0];
              ii->size[0] = bsb->size[0];
              emxEnsureCapacity_int32_T(sp, ii, i, &et_emlrtRTEI);
              loop_ub = bsb->size[0];
              for (i = 0; i < loop_ub; i++) {
                if (bsb->data[i] !=
              ...
              i = r3->size[0];
              r3->size[0] = trueCount;
              emxEnsureCapacity_int32_T(sp, r3, i, &bt_emlrtRTEI);
              partialTrueCount = 0;
              for (b_i = 0; b_i <= k; b_i++) {
                if (bsbT->data[b_i]) {
        ...
        i = ym->size[0] * ym->size[1];
        ym->size[0] = 1;
        emxEnsureCapacity_real_T(sp, ym, i, &dt_emlrtRTEI);
        loop_ub = ym->size[1] - 1;
        for (i = 0; i <= loop_ub; i++) {
          ym->data[i] /= b_mm;
        }
        ...
        if (b_mm - (real_T)lunit > (real_T)v + 1.0) {
          ...
          if (lunit > 1) {
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              emxEnsureCapacity_boolean_T(sp, MDltminT, i, &jt_emlrtRTEI);
              loop_ub = bsbT->size[0];
              for (i = 0; i < loop_ub; i++) {
              ...
              emxEnsureCapacity_real_T(sp, unitout, i, &bt_emlrtRTEI);
              partialTrueCount = 0;
              for (b_i = 0; b_i <= k; b_i++) {
                if (oldbsbT->data[b_i] && MDltminT->data[b_i]) {
                  if (b_i + 1 > seq->size[0]) {
            ...
            for (i = 0; i < loop_ub; i++) {
              ...
              if ((k < 1) || (k > Y->size[0])) {
                emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &lr_emlrtBCI,
                                              &st);
              }
            }
            b_st.site = &nm_emlrtRSI;
            ...
            b_Y->size[1] = Y->size[1];
            emxEnsureCapacity_real_T(&b_st, b_Y, i, &mt_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
            ...
            mi->size[0] = 1;
            emxEnsureCapacity_real_T(sp, mi, i, &qt_emlrtRTEI);
            loop_ub = mi->size[1] - 1;
            for (i = 0; i <= loop_ub; i++) {
            ...
            if ((b_mm > percn) || (rankgap > 10.0)) {
              ...
              i = r7->size[0];
              r7->size[0] = trueCount;
              emxEnsureCapacity_int32_T(sp, r7, i, &bt_emlrtRTEI);
              partialTrueCount = 0;
              for (b_i = 0; b_i <= k; b_i++) {
                if (oldbsbT->data[b_i] && bsbT->data[b_i]) {
              ...
              b_Y->size[1] = Y->size[1];
              emxEnsureCapacity_real_T(&b_st, b_Y, i, &au_emlrtRTEI);
              for (i = 0; i < loop_ub; i++) {
                irank = r7->size[0];
                for (k = 0; k < irank; k++) {
                  b_Y->data[k + b_Y->size[0] * i] =
              ...
              b_Y->size[1] = Y->size[1];
              emxEnsureCapacity_real_T(&b_st, b_Y, i, &vt_emlrtRTEI);
              for (i = 0; i < loop_ub; i++) {
                irank = bsbr->size[0];
                for (k = 0; k < irank; k++) {
                  b_Y->data[k + b_Y->size[0] * i] =
              ...
              i = mibsbr->size[0] * mibsbr->size[1];
              mibsbr->size[0] = 1;
              emxEnsureCapacity_real_T(sp, mibsbr, i, &xt_emlrtRTEI);
              ksor = (b_mm - 1.0) - (real_T)unitout->size[0];
              loop_ub = mibsbr->size[1] - 1;
              for (i = 0; i <= loop_ub; i++) {
                mibsbr->data[i] /= ksor;
            ...
            zi->size[0] = 1;
            zi->size[1] = mi->size[1];
            emxEnsureCapacity_real_T(sp, zi, i, &eu_emlrtRTEI);
            loop_ub = mi->size[1];
            for (i = 0; i < loop_ub; i++) {
            ...
            R->size[0] = Szi->size[0];
            R->size[1] = Szi->size[0];
            emxEnsureCapacity_real_T(sp, R, i, &hu_emlrtRTEI);
            loop_ub = Szi->size[0];
            for (i = 0; i < loop_ub; i++) {
              irank = Szi->size[0];
              for (k = 0; k < irank; k++) {
            ...
            emlrtSizeEqCheckNDR2012b(&b_ym[0], &iv[0], &gc_emlrtECI,
                                     (emlrtCTX)sp);
            ...
            if (unitout->size[0] > 1) {
              ...
              for (b_i = 0; b_i < i; b_i++) {
                ...
                if ((k < 1) || (k > Y->size[0])) {
                  emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &lq_emlrtBCI,
                                                (emlrtCTX)sp);
                }
                loop_ub = Y->size[1];
                ...
                zi->size[0] = 1;
                zi->size[1] = Y->size[1];
                emxEnsureCapacity_real_T(sp, zi, k, &nu_emlrtRTEI);
                for (k = 0; k < loop_ub; k++) {
                  zi->data[k] =
                ...
                emlrtSizeEqCheckNDR2012b(&b_ym[0], &iv[0], &hc_emlrtECI,
                                         (emlrtCTX)sp);
                loop_ub = Y->size[1];
                k = zi->size[0] * zi->size[1];
                zi->size[0] = 1;
                zi->size[1] = Y->size[1];
                emxEnsureCapacity_real_T(sp, zi, k, &ou_emlrtRTEI);
                for (k = 0; k < loop_ub; k++) {
                  zi->data[k] =
                      Y->data[((int32_T)unitout->data[b_i] + Y->size[0] * k) -
                              1] -
                ...
                R->size[0] = Szi->size[0];
                R->size[1] = Szi->size[0];
                emxEnsureCapacity_real_T(sp, R, k, &ru_emlrtRTEI);
                loop_ub = Szi->size[0];
                for (k = 0; k < loop_ub; k++) {
                  irank = Szi->size[0];
            ...
            emxEnsureCapacity_real_T(sp, mibsbr, i, &gt_emlrtRTEI);
          ...
          for (i = 0; i < loop_ub; i++) {
            k = unit->data[i];
            if ((k < 1) || (k > Y->size[0])) {
              emlrtDynamicBoundsCheckR2012b(k, 1, Y->size[0], &kr_emlrtBCI,
                                            &st);
            }
          }
          b_st.site = &nm_emlrtRSI;
          ...
          b_Y->size[1] = Y->size[1];
          emxEnsureCapacity_real_T(&b_st, b_Y, i, &kt_emlrtRTEI);
          for (i = 0; i < loop_ub; i++) {
            irank = unit->size[0];
            for (k = 0; k < irank; k++) {
              b_Y->data[k + b_Y->size[0] * i] =
          ...
          i = mi->size[0] * mi->size[1];
          mi->size[0] = 1;
          emxEnsureCapacity_real_T(sp, mi, i, &nt_emlrtRTEI);
          loop_ub = mi->size[1] - 1;
          for (i = 0; i <= loop_ub; i++) {
          ...
          zi->size[0] = 1;
          zi->size[1] = mi->size[1];
          emxEnsureCapacity_real_T(sp, zi, i, &rt_emlrtRTEI);
          loop_ub = mi->size[1];
          for (i = 0; i < loop_ub; i++) {
            zi->data[i] = a * (mi->data[i] - mibsbr->data[i]);
          }
          ...
          R->size[0] = Szi->size[0];
          R->size[1] = Szi->size[0];
          emxEnsureCapacity_real_T(sp, R, i, &wt_emlrtRTEI);
          loop_ub = Szi->size[0];
          for (i = 0; i < loop_ub; i++) {
            irank = Szi->size[0];
            for (k = 0; k < irank; k++) {
          ...
          if (lunit > 1) {
            ...
            for (b_i = 0; b_i < lunit; b_i++) {
              ...
              i = unit->data[b_i];
              if ((i < 1) || (i > Y->size[0])) {
                emlrtDynamicBoundsCheckR2012b(i, 1, Y->size[0], &mq_emlrtBCI,
                                              (emlrtCTX)sp);
              }
              loop_ub = Y->size[1];
              i = zi->size[0] * zi->size[1];
              zi->size[0] = 1;
              zi->size[1] = Y->size[1];
              emxEnsureCapacity_real_T(sp, zi, i, &fu_emlrtRTEI);
              for (i = 0; i < loop_ub; i++) {
              ...
              zi->size[0] = 1;
              zi->size[1] = Y->size[1];
              emxEnsureCapacity_real_T(sp, zi, i, &iu_emlrtRTEI);
              for (i = 0; i < loop_ub; i++) {
                zi->data[i] = Y->data[(unit->data[b_i] + Y->size[0] * i) - 1] -
                              mi->data[i];
              }
              ...
              R->size[0] = Szi->size[0];
              R->size[1] = Szi->size[0];
              emxEnsureCapacity_real_T(sp, R, i, &ku_emlrtRTEI);
              loop_ub = Szi->size[0];
              for (i = 0; i < loop_ub; i++) {
                irank = Szi->size[0];
                for (k = 0; k < irank; k++) {
          ...
          if (n < 30000) {
            ...
            b_Y->size[0] = R->size[0];
            b_Y->size[1] = R->size[1];
            emxEnsureCapacity_real_T(sp, b_Y, i, &gu_emlrtRTEI);
          ...
          if (b_mm > percn) {
            ...
            i = r4->size[0];
            r4->size[0] = trueCount;
            emxEnsureCapacity_int32_T(sp, r4, i, &bt_emlrtRTEI);
            partialTrueCount = 0;
            for (b_i = 0; b_i <= k; b_i++) {
              if (bsbT->data[b_i]) {
            ...
            R->size[0] = r4->size[0];
            R->size[1] = Ym->size[1];
            emxEnsureCapacity_real_T(sp, R, i, &it_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = r4->size[0];
              for (k = 0; k < irank; k++) {
            ...
            i = r5->size[0];
            r5->size[0] = trueCount;
            emxEnsureCapacity_int32_T(sp, r5, i, &bt_emlrtRTEI);
            partialTrueCount = 0;
            for (b_i = 0; b_i <= k; b_i++) {
              if (bsbT->data[b_i]) {
            ...
            Yb->size[0] = r5->size[0];
            Yb->size[1] = Ym->size[1];
            emxEnsureCapacity_real_T(&st, Yb, i, &ot_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = r5->size[0];
              for (k = 0; k < irank; k++) {
            ...
            i = r6->size[0];
            r6->size[0] = trueCount;
            emxEnsureCapacity_int32_T(sp, r6, i, &bt_emlrtRTEI);
            partialTrueCount = 0;
            for (b_i = 0; b_i <= k; b_i++) {
              if (bsbT->data[b_i]) {
            ...
            emxEnsureCapacity_real_T(sp, b_Y, i, &tt_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = r6->size[0];
              for (k = 0; k < irank; k++) {
            ...
            R->size[0] = bsb->size[0];
            R->size[1] = Ym->size[1];
            emxEnsureCapacity_real_T(sp, R, i, &ft_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = bsb->size[0];
              for (k = 0; k < irank; k++) {
                if (bsb->data[k] !=
            ...
            Yb->size[0] = bsb->size[0];
            Yb->size[1] = Ym->size[1];
            emxEnsureCapacity_real_T(&st, Yb, i, &ht_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = bsb->size[0];
              for (k = 0; k < irank; k++) {
                partialTrueCount = (int32_T)bsb->data[k];
            ...
            b_Y->size[0] = bsb->size[0];
            b_Y->size[1] = Ym->size[1];
            emxEnsureCapacity_real_T(sp, b_Y, i, &lt_emlrtRTEI);
            for (i = 0; i < loop_ub; i++) {
              irank = bsb->size[0];
              for (k = 0; k < irank; k++) {
                partialTrueCount = (int32_T)bsb->data[k];
          ...
          emxEnsureCapacity_boolean_T(&st, MDltminT, i, &pt_emlrtRTEI);
          loop_ub = S->size[0] * S->size[1];
          for (i = 0; i < loop_ub; i++) {
          ...
          if (irank > 0) {
            ...
            Un->size[0] = 1;
            Un->size[1] = 1;
            emxEnsureCapacity_real_T(sp, Un, i, &st_emlrtRTEI);
            Un->data[0] = rtNaN;
            i = BB->size[0] * BB->size[1];
            BB->size[0] = 1;
            BB->size[1] = 1;
            emxEnsureCapacity_real_T(sp, BB, i, &ut_emlrtRTEI);
            BB->data[0] = rtNaN;
            exitg1 = true;
          } else {
            ...
            if (R->size[1] != Ym->size[1]) {
              emlrtErrorWithMessageIdR2018a(
                  &st, &vb_emlrtRTEI, "MATLAB:dimagree", "MATLAB:dimagree", 0);
            }
        ...
        if (b_guard1) {
          if (b_mm < n) {
            ...
            emxEnsureCapacity_real_T(sp, Szi, i, &yt_emlrtRTEI);
            loop_ub = MD->size[0];
            for (i = 0; i < loop_ub; i++) {
            ...
            if (b_mm > percn) {
              ...
              i = ii->size[0];
              ii->size[0] = bsb->size[0];
              emxEnsureCapacity_int32_T(sp, ii, i, &bu_emlrtRTEI);
              loop_ub = bsb->size[0];
              for (i = 0; i < loop_ub; i++) {
                if (bsb->data[i] !=
                    (int32_T)muDoubleScalarFloor(bsb->data[i])) {
            ...
            emxEnsureCapacity_boolean_T(sp, MDltminT, i, &ju_emlrtRTEI);
            loop_ub = MD->size[0];
            for (i = 0; i < loop_ub; i++) {
            ...
            if (b_mm > percn) {
              ...
              emxEnsureCapacity_boolean_T(sp, MDltminbsb, i, &mu_emlrtRTEI);
              ...
              emxEnsureCapacity_boolean_T(sp, MDltminbsb, i, &lu_emlrtRTEI);
              loop_ub = bsb->size[0];
              for (i = 0; i < loop_ub; i++) {
                if (bsb->data[i] !=
                    (int32_T)muDoubleScalarFloor(bsb->data[i])) {
            ...
            if (rankgap == 1.0) {
              ...
              i = unit->size[0];
              unit->size[0] = 1;
              emxEnsureCapacity_int32_T(sp, unit, i, &pu_emlrtRTEI);
              unit->data[0] = idx;
              ...
              if (b_mm <= percn) {
                ...
                k = bsb->size[0];
                bsb->size[0]++;
                emxEnsureCapacity_real_T(sp, bsb, k, &bt_emlrtRTEI);
                bsb->data[i] = idx;
              }
              ...
              i = Szi->size[0];
              Szi->size[0] = MD->size[0];
              emxEnsureCapacity_real_T(sp, Szi, i, &su_emlrtRTEI);
              loop_ub = MD->size[0];
              for (i = 0; i < loop_ub; i++) {
                Szi->data[i] = MD->data[i];
              }
              ...
              if (b_mm <= percn) {
                ...
                emxEnsureCapacity_uint32_T(sp, bsbrini, i, &bt_emlrtRTEI);
                partialTrueCount = 0;
                for (b_i = 0; b_i <= k; b_i++) {
                  if (MDltminT->data[(int32_T)bsb->data[b_i] - 1]) {
                    if (b_i + 1 > bsb->size[0]) {
                ...
                emxEnsureCapacity_boolean_T(sp, bsbriniT, i, &vu_emlrtRTEI);
              ...
              for (loop_ub = 0; loop_ub < i; loop_ub++) {
                ...
                if (bsbT->data[idx - 1]) {
                  if (b_mm <= percn) {
                    if ((zz + 1 < 1) || (zz + 1 > 10)) {
                      emlrtDynamicBoundsCheckR2012b(zz + 1, 1, 10, &pq_emlrtBCI,
                                                    (emlrtCTX)sp);
                    }
                    bsbradd[zz] = idx;
                    zz++;
                      ...
                      if ((int32_T)unitout->data[b_i] != idx) {
                        if (b_i + 1 > unitout->size[0]) {
                          emlrtDynamicBoundsCheckR2012b(
                              b_i + 1, 1, unitout->size[0], &ks_emlrtBCI,
                              (emlrtCTX)sp);
                        }
                    ...
                    k = unitout->size[0];
                    unitout->size[0] = trueCount;
                    emxEnsureCapacity_real_T(sp, unitout, k, &bt_emlrtRTEI);
                  } else {
              ...
              if (1 > lunit) {
                ...
                emlrtDynamicBoundsCheckR2012b(lunit, 1, 10, &oq_emlrtBCI,
                                              (emlrtCTX)sp);
              }
              i = unit->size[0];
              unit->size[0] = lunit;
              emxEnsureCapacity_int32_T(sp, unit, i, &bv_emlrtRTEI);
              for (i = 0; i < lunit; i++) {
              ...
              if (b_mm <= percn) {
                if (1 > zz) {
                  ...
                  emlrtDynamicBoundsCheckR2012b(zz, 1, 10, &qq_emlrtBCI,
                                                (emlrtCTX)sp);
                }
                i = bsbr->size[0];
                bsbr->size[0] = bsbrini->size[0] + zz;
                emxEnsureCapacity_int32_T(sp, bsbr, i, &cv_emlrtRTEI);
                loop_ub = bsbrini->size[0];
                for (i = 0; i < loop_ub; i++) {
                ...
                emxEnsureCapacity_real_T(sp, bsb, i, &ev_emlrtRTEI);
                loop_ub = bsbr->size[0];
                for (i = 0; i < loop_ub; i++) {
                ...
                i = bsbT->size[0];
                bsbT->size[0] = n;
                emxEnsureCapacity_boolean_T(sp, bsbT, i, &hv_emlrtRTEI);
                for (i = 0; i < n; i++) {
                  bsbT->data[i] = false;
                }
                i = ii->size[0];
                ii->size[0] = bsb->size[0];
                emxEnsureCapacity_int32_T(sp, ii, i, &jv_emlrtRTEI);
                loop_ub = bsb->size[0];
                for (i = 0; i < loop_ub; i++) {
                  k = (int32_T)bsb->data[i];
                  if ((k < 1) || (k > n)) {
                ...
                emxEnsureCapacity_boolean_T(sp, bsbT, i, &fv_emlrtRTEI);
              ...
              i = Szi->size[0];
              Szi->size[0] = MD->size[0];
              emxEnsureCapacity_real_T(sp, Szi, i, &qu_emlrtRTEI);
              loop_ub = MD->size[0] - 1;
              for (i = 0; i <= loop_ub; i++) {
                Szi->data[i] = MD->data[i];
              }
              ...
              emxEnsureCapacity_boolean_T(sp, bsbT, i, &tu_emlrtRTEI);
              loop_ub = MD->size[0];
              for (i = 0; i < loop_ub; i++) {
              ...
              if (irank == (int32_T)b_mm + 1) {
                if (b_mm <= percn) {
                  ...
                  emxEnsureCapacity_real_T(sp, bsb, i, &bt_emlrtRTEI);
                  partialTrueCount = 0;
                  for (b_i = 0; b_i <= k; b_i++) {
                    if (bsbT->data[b_i]) {
                      if (b_i + 1 > seq->size[0]) {
                ...
                if (1.0 > a) {
                  ...
                  if (1 > trueCount) {
                    emlrtDynamicBoundsCheckR2012b(1, 1, trueCount, &rq_emlrtBCI,
                                                  (emlrtCTX)sp);
                  }
                  k = MD->size[0];
                  trueCount = 0;
                ...
                i = r8->size[0];
                r8->size[0] = trueCount;
                emxEnsureCapacity_int32_T(sp, r8, i, &bt_emlrtRTEI);
                partialTrueCount = 0;
                irank = MD->size[0] - 1;
                trueCount = 0;
                for (b_i = 0; b_i <= k; b_i++) {
                ...
                i = r9->size[0];
                r9->size[0] = trueCount;
                emxEnsureCapacity_int32_T(sp, r9, i, &bt_emlrtRTEI);
                partialTrueCount = 0;
                ...
                emxEnsureCapacity_real_T(sp, bsb, i, &dv_emlrtRTEI);
                irank = r8->size[0];
                for (i = 0; i < irank; i++) {
                ...
                i = bsbT->size[0];
                bsbT->size[0] = n;
                emxEnsureCapacity_boolean_T(sp, bsbT, i, &gv_emlrtRTEI);
                for (i = 0; i < n; i++) {
                  bsbT->data[i] = false;
                }
                i = ii->size[0];
                ii->size[0] = bsb->size[0];
                emxEnsureCapacity_int32_T(sp, ii, i, &iv_emlrtRTEI);
                loop_ub = bsb->size[0];
                for (i = 0; i < loop_ub; i++) {
                  k = (int32_T)bsb->data[i];
                  if (bsb->data[i] != k) {
              ...
              emxEnsureCapacity_boolean_T(sp, MDltminT, i, &wu_emlrtRTEI);
              ...
              i = MDltminT->size[0];
              MDltminT->size[0] = bsbT->size[0];
              emxEnsureCapacity_boolean_T(&st, MDltminT, i, &xu_emlrtRTEI);
              loop_ub = bsbT->size[0];
              for (i = 0; i < loop_ub; i++) {
              ...
              emxEnsureCapacity_int32_T(&st, unit, i, &yu_emlrtRTEI);
              loop_ub = ii->size[0];
              for (i = 0; i < loop_ub; i++) {
            ...
            emxEnsureCapacity_real_T(sp, meoldbsb, i, &uu_emlrtRTEI);
            loop_ub = ym->size[1];
            for (i = 0; i < loop_ub; i++) {
  ...
  if (guard1) {
    ...
    Un->size[0] = 1;
    Un->size[1] = 1;
    emxEnsureCapacity_real_T(sp, Un, i, &ws_emlrtRTEI);
    Un->data[0] = rtNaN;
    i = BB->size[0] * BB->size[1];
    BB->size[0] = 1;
    BB->size[1] = 1;
    emxEnsureCapacity_real_T(sp, BB, i, &xs_emlrtRTEI);
    BB->data[0] = rtNaN;
  }
  emxFree_real_T(&b_Y);
  emxFree_int32_T(&ii);
