 ...
 *
 * LXS_wrapper_emxutil.c
 *
 * Code generation for function 'LXS_wrapper_emxutil'
 *
 */
...
void c_emxInitStruct_struct_LXSlmssc(const emlrtStack *sp,
...
/* End of code generation (LXS_wrapper_emxutil.c) */
