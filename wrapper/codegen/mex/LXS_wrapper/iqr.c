...
real_T iqr(const emlrtStack *sp, const emxArray_real_T *x)
{
  ...
  if (x->size[0] == 0) {
    ...
    while ((!exitg1) && (nj > 0)) {
      if (nj > idx->size[0]) {
        emlrtDynamicBoundsCheckR2012b(nj, 1, idx->size[0], &ll_emlrtBCI, &c_st);
      }
      i = idx->data[nj - 1];
      if ((i < 1) || (i > x->size[0])) {
        emlrtDynamicBoundsCheckR2012b(i, 1, x->size[0], &ll_emlrtBCI, &c_st);
      }
    ...
    if (nj < 1) {
      ...
      if (b_i >= nj) {
        if (nj > idx->size[0]) {
          emlrtDynamicBoundsCheckR2012b(nj, 1, idx->size[0], &nl_emlrtBCI,
                                        &b_st);
        }
        i = idx->data[nj - 1];
        if ((i < 1) || (i > x->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i, 1, x->size[0], &nl_emlrtBCI, &b_st);
        }
        ...
        i = idx->data[b_i - 1];
        if ((i < 1) || (i > x->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i, 1, x->size[0], &ol_emlrtBCI, &b_st);
        }
        if (b_i + 1 > idx->size[0]) {
        ...
        if ((b_i < 1) || (b_i > x->size[0])) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, x->size[0], &pl_emlrtBCI,
                                        &b_st);
        }
