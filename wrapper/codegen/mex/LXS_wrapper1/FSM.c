         ...
         int32_T out_class_size[2])
{
  ...
  emxArray_char_T_1x310 djb_emlrtRSI;
  emxArray_int32_T *ia;
  emxArray_int32_T *r1;
  emxArray_int32_T *r2;
  emxArray_int32_T *r3;
        ...
        if (guard4) {
          if (c_i == out_mmd->size[0] - 1) {
            ...
            if (d > b_tmp) {
              ...
              st.site = &qg_emlrtRSI;
              int2str(&st, out_mmd->data[c_i - 1], djb_emlrtRSI.data,
                      djb_emlrtRSI.size);
              st.site = &qg_emlrtRSI;
              int2str(&st, n, djb_emlrtRSI.data, djb_emlrtRSI.size);
            }
          ...
          if (d > b_tmp) {
            ...
            if (out_mmd->data[c_i + out_mmd->size[0]] > gmin->data[c_i +
              ...
              if (out_mmd->data[(c_i + out_mmd->size[0]) - 2] > gmin->data[(c_i
                ...
                st.site = &xg_emlrtRSI;
                int2str(&st, out_mmd->data[c_i - 2], djb_emlrtRSI.data,
                        djb_emlrtRSI.size);
                st.site = &xg_emlrtRSI;
                int2str(&st, n, djb_emlrtRSI.data, djb_emlrtRSI.size);
                if (((int32_T)(c_i + 1U) < 1) || ((int32_T)(c_i + 1U) >
                ...
                st.site = &xg_emlrtRSI;
                int2str(&st, out_mmd->data[c_i], djb_emlrtRSI.data,
                        djb_emlrtRSI.size);
                st.site = &xg_emlrtRSI;
                int2str(&st, n, djb_emlrtRSI.data, djb_emlrtRSI.size);
                if ((c_i + -1 < 1) || (c_i + -1 > out_mmd->size[0])) {
        ...
        while ((!exitg2) && (irank <= i - 1)) {
          ...
          while ((!exitg3) && (idx <= i1)) {
            ...
            if ((d > gmin1->data[((int32_T)ii + gmin1->size[0] * (c99 - 1)) - 1])
              ...
              st.site = &jg_emlrtRSI;
              int2str(&st, out_mmd->data[(int32_T)ii - 1], djb_emlrtRSI.data,
                      djb_emlrtRSI.size);
              st.site = &jg_emlrtRSI;
              int2str(&st, ndecl, djb_emlrtRSI.data, djb_emlrtRSI.size);
              sto = 1;
              exitg3 = true;
            } else {
              guard1 = false;
