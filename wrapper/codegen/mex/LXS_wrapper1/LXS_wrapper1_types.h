...
#ifndef typedef_LXS_wrapper1StackData
#define typedef_LXS_wrapper1StackData
typedef struct {
  struct {
    creal_T The1max[7202];
    creal_T new1[7202];
  } f0;
} LXS_wrapper1StackData;
#endif /* typedef_LXS_wrapper1StackData */

/* End of code generation (LXS_wrapper1_types.h) */
