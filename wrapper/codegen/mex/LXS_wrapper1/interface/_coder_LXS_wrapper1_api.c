...
static struct0_T s_emlrt_marshallIn(const emlrtStack *sp, const mxArray *lms,
                                    const char_T *identifier);
                      ...
                      int32_T nlhs, const mxArray *plhs[2])
{
  ...
  emxInitStruct_struct_LXS_T(&st, &out, &wx_emlrtRTEI, true);
