...
void pascal(const emlrtStack *sp, real_T n, emxArray_real_T *P)
{
  ...
  if (!(n == muDoubleScalarFloor(n))) {
    emlrtErrorWithMessageIdR2018a(
        sp, &eb_emlrtRTEI, "Coder:toolbox:pascal_nMustBeNonNegativeInteger",
  ...
  if ((int32_T)n < 2) {
    ...
    P->size[0] = (int32_T)n;
    P->size[1] = (int32_T)n;
    emxEnsureCapacity_real_T(sp, P, i, &xf_emlrtRTEI);
    ...
    P->size[0] = (int32_T)n;
    P->size[1] = (int32_T)n;
    emxEnsureCapacity_real_T(sp, P, i, &wf_emlrtRTEI);
    loop_ub = (int32_T)n * (int32_T)n;
    for (i = 0; i < loop_ub; i++) {
      P->data[i] = 0.0;
    }
    ...
    emxInit_real_T(sp, &A, 2, &yf_emlrtRTEI, true);
    st.site = &nf_emlrtRSI;
    ...
    A->size[0] = P->size[0];
    A->size[1] = P->size[1];
    emxEnsureCapacity_real_T(&d_st, A, i, &yf_emlrtRTEI);
    ...
    P->size[0] = mA;
    P->size[1] = mB;
    emxEnsureCapacity_real_T(&d_st, P, i, &le_emlrtRTEI);
