...
static emlrtRSInfo th_emlrtRSI = { 374,/* lineNo */
  ...
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo wh_emlrtRSI = { 294,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo xh_emlrtRSI = { 242,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo yh_emlrtRSI = { 220,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo ai_emlrtRSI = { 198,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo di_emlrtRSI = { 128,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo ei_emlrtRSI = { 126,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRSInfo gi_emlrtRSI = { 180,/* lineNo */
  "eml_gammainc",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pathName */
};

static emlrtRTEInfo q_emlrtRTEI = { 356,/* lineNo */
  13,                                  /* colNo */
  "eml_gammainc",                      /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pName */
};

static emlrtRTEInfo r_emlrtRTEI = { 276,/* lineNo */
  13,                                  /* colNo */
  "eml_gammainc",                      /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\specfun\\private\\eml_gammainc.m"/* pName */
};
...
real_T b_eml_gammainc(const emlrtStack *sp, real_T x, real_T a, real_T la,
                      real_T lgap1)
{
  static const real_T dv[31] = { 0.0, 0.15342640972002736, 0.081061466795327261,
  ...
  if (!(x > 0.0)) {
    ...
    if (a <= 15.0) {
      ...
      asq = a * a;
      stirlerr = ((((0.00084175084175084171 / asq + -0.00059523809523809529) /
                    asq + 0.00079365079365079365) / asq + -0.0027777777777777779)
                  / asq + 0.083333333333333329) / a;
    }
    ...
    if (x > 1.0E+6) {
      ...
      if (t < 15.0) {
        ...
        a1 = 0.5 * ((((((((((((((((((((((0.0012710976495261409 * (asq - 0.5) +
          ...
          0.5) + -0.0838864557023002) * (asq - 0.5) + -0.11946395996432542) *
                    ...
                    0.27537474159737679) * asq * muDoubleScalarExp(-dj * dj) *
          2.5066282746310002 * muDoubleScalarExp(0.5 * xD0);
      ...
      emlrtForLoopVectorCheckR2012b(n - 1.0, -1.0, 1.0, mxDOUBLE_CLASS, i,
        &r_emlrtRTEI, sp);
      for (b_i = 0; b_i < i; b_i++) {
      ...
      if (n <= d) {
        ...
        if (dj == 0.0) {
          ...
          asq = muDoubleScalarSqrt(3.1415926535897931 * x) * muDoubleScalarExp(x)
            * (2.0 * (0.5 * ((((((((((((((((((((((0.0012710976495261409 * (t -
            0.5) + 0.00011931402283834095) * (t - 0.5) + -0.0039638509736051354)
            * (t - 0.5) + -0.00087077963531729586) * (t - 0.5) +
            ...
            * (t - 0.5) + 0.0024936720005350331) * (t - 0.5) +
            ...
            0.5) + 1.3704021768233816) * (t - 0.5) + 1.313146538310231) * (t -
                     0.5) + 1.0792551515585667) * (t - 0.5) +
                               0.77436819911953858) * (t - 0.5) +
                              0.49016508058531844) * (t - 0.5) +
                             0.27537474159737679) * t * muDoubleScalarExp(-dj *
                 dj)));
          n++;
        } else {
          vsq = 1.0;
          ...
          asq = t;
          stirlerr = 0.0;
          while (muDoubleScalarAbs(asq - stirlerr) > 2.2204460492503131E-16 *
                 asq) {
            stirlerr = asq;
            asq = n - dj;
            vsq = (a1 + vsq * asq) * t;
  ...
  if (!(x > 0.0)) {
    ...
    if (x > 1.0E+6) {
      ...
      if (t < 15.0) {
        ...
        dj = 0.5 * ((((((((((((((((((((((0.0012710976495261409 * (dj - 0.5) +
          ...
          (dj - 0.5) + 0.0024936720005350331) * (dj - 0.5) + -0.0838864557023002)
                    ...
                    0.27537474159737679) * dj * muDoubleScalarExp(-v * v) *
          2.5066282746310002 * muDoubleScalarExp(0.5 * tsq);
        vsq = (dj * ((tsq - 3.0) * t) - (tsq - 4.0)) / 6.0;
        old = (dj * ((tsq * tsq - 9.0) * tsq + 6.0) - ((tsq - 1.0) * tsq - 6.0) *
               t) / 72.0;
        v = (dj * (((((5.0 * tsq + 45.0) * tsq - 81.0) * tsq - 315.0) * tsq +
                    270.0) * t) - ((((5.0 * tsq + 40.0) * tsq - 111.0) * tsq -
               174.0) * tsq + 192.0)) / 6480.0;
      } else {
      ...
      do {
        ...
        t = v / (dj + 0.5);
        vsq += t;
        if (muDoubleScalarAbs(t) <= muDoubleScalarAbs(vsq) *
      ...
      if ((int32_T)dj <= i) {
        ...
        v = muDoubleScalarSqrt(3.1415926535897931 * x) * muDoubleScalarExp(x) *
          (2.0 * (0.5 * ((((((((((((((((((((((0.0012710976495261409 * (t - 0.5)
          ...
          * (t - 0.5) + -0.013382364453346007) * (t - 0.5) +
          0.016131532973325226) * (t - 0.5) + 0.039097684558848406) * (t - 0.5)
          + 0.0024936720005350331) * (t - 0.5) + -0.0838864557023002) * (t - 0.5)
          + -0.11946395996432542) * (t - 0.5) + 0.016620792496936737) * (t - 0.5)
          + 0.35752427444953105) * (t - 0.5) + 0.80527640875291062) * (t - 0.5)
                   + 1.1890298290927332) * (t - 0.5) + 1.3704021768233816) * (t
                  - 0.5) + 1.313146538310231) * (t - 0.5) + 1.0792551515585667) *
      ...
      emlrtForLoopVectorCheckR2012b(dj - 1.0, -1.0, 1.0, mxDOUBLE_CLASS, i,
        &q_emlrtRTEI, sp);
      for (b_i = 0; b_i < i; b_i++) {
