...
static emlrtRSInfo cc_emlrtRSI = { 29, /* lineNo */
  "nullAssignment",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo dc_emlrtRSI = { 33, /* lineNo */
  "nullAssignment",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo ec_emlrtRSI = { 356,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo fc_emlrtRSI = { 357,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo gc_emlrtRSI = { 365,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo hc_emlrtRSI = { 367,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo ic_emlrtRSI = { 370,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRSInfo jc_emlrtRSI = { 372,/* lineNo */
  "delete_columns",                    /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};
...
static emlrtRSInfo lc_emlrtRSI = { 132,/* lineNo */
  "num_true",                          /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pathName */
};

static emlrtRTEInfo t_emlrtRTEI = { 379,/* lineNo */
  1,                                   /* colNo */
  "delete_columns",                    /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pName */
};

static emlrtRTEInfo u_emlrtRTEI = { 81,/* lineNo */
  27,                                  /* colNo */
  "validate_inputs",                   /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pName */
};

static emlrtRTEInfo gd_emlrtRTEI = { 365,/* lineNo */
  9,                                   /* colNo */
  "nullAssignment",                    /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pName */
};

static emlrtRTEInfo hd_emlrtRTEI = { 380,/* lineNo */
  5,                                   /* colNo */
  "nullAssignment",                    /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pName */
};

static emlrtRTEInfo id_emlrtRTEI = { 363,/* lineNo */
  9,                                   /* colNo */
  "nullAssignment",                    /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\nullAssignment.m"/* pName */
};
                    ...
                    emxArray_int32_T *idx)
{
  ...
  if (!overflow) {
    emlrtErrorWithMessageIdR2018a(&st, &u_emlrtRTEI, "MATLAB:subsdeldimmismatch",
  ...
  if (idx->size[1] == 1) {
    ...
    emxInit_boolean_T(&st, &b, 2, &id_emlrtRTEI, true);
    b_st.site = &gc_emlrtRSI;
    j = b->size[0] * b->size[1];
    b->size[0] = 1;
    b->size[1] = x->size[1];
    emxEnsureCapacity_boolean_T(&b_st, b, j, &gd_emlrtRTEI);
    ncols = x->size[1];
    for (j = 0; j < ncols; j++) {
      b->data[j] = false;
    }
  ...
  emxInit_real_T(&st, &b_x, 2, &hd_emlrtRTEI, true);
  if (1 > ncols) {
    ncols = 0;
  }
  ...
  b_x->size[0] = b_b + 1;
  b_x->size[1] = ncols;
  emxEnsureCapacity_real_T(&st, b_x, j, &hd_emlrtRTEI);
  for (j = 0; j < ncols; j++) {
    for (nrowx = 0; nrowx <= b_b; nrowx++) {
  ...
  x->size[0] = b_x->size[0];
  x->size[1] = b_x->size[1];
  emxEnsureCapacity_real_T(&st, x, j, &hd_emlrtRTEI);
  ncols = b_x->size[1];
  for (j = 0; j < ncols; j++) {
    b_b = b_x->size[0];
    for (nrowx = 0; nrowx < b_b; nrowx++) {
