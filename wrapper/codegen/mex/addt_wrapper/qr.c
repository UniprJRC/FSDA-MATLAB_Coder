...
static emlrtRSInfo fd_emlrtRSI = { 35, /* lineNo */
  "eml_qr",                            /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo gd_emlrtRSI = { 153,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo hd_emlrtRSI = { 161,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo id_emlrtRSI = { 162,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo jd_emlrtRSI = { 165,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo kd_emlrtRSI = { 169,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo ld_emlrtRSI = { 170,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo md_emlrtRSI = { 174,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo nd_emlrtRSI = { 176,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};

static emlrtRSInfo od_emlrtRSI = { 177,/* lineNo */
  "qr_econ",                           /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pathName */
};
...
static emlrtRSInfo sd_emlrtRSI = { 94, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgeqrf.m"/* pathName */
};

static emlrtRSInfo td_emlrtRSI = { 99, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgeqrf.m"/* pathName */
};
...
static emlrtRTEInfo cc_emlrtRTEI = { 75,/* lineNo */
  5,                                   /* colNo */
  "xgeqrf",                            /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgeqrf.m"/* pName */
};

static emlrtRTEInfo dc_emlrtRTEI = { 158,/* lineNo */
  20,                                  /* colNo */
  "eml_qr",                            /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pName */
};

static emlrtRTEInfo ec_emlrtRTEI = { 175,/* lineNo */
  20,                                  /* colNo */
  "eml_qr",                            /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pName */
};

static emlrtRTEInfo fc_emlrtRTEI = { 174,/* lineNo */
  1,                                   /* colNo */
  "eml_qr",                            /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\matfun\\private\\eml_qr.m"/* pName */
};
        ...
        emxArray_real_T *R)
{
  ...
  emxInit_real_T(sp, &b_A, 2, &gc_emlrtRTEI, true);
  st.site = &ed_emlrtRSI;
  b_st.site = &fd_emlrtRSI;
  i = b_A->size[0] * b_A->size[1];
  b_A->size[0] = A->size[0];
  b_A->size[1] = A->size[1];
  emxEnsureCapacity_real_T(&b_st, b_A, i, &ac_emlrtRTEI);
  na = A->size[0] * A->size[1];
  for (i = 0; i < na; i++) {
    b_A->data[i] = A->data[i];
  }

  emxInit_real_T(&b_st, &tau, 1, &gc_emlrtRTEI, true);
  ...
  i = tau->size[0];
  tau->size[0] = minmana;
  emxEnsureCapacity_real_T(&d_st, tau, i, &bc_emlrtRTEI);
  if ((b_A->size[0] == 0) || (b_A->size[1] == 0)) {
    i = tau->size[0];
    tau->size[0] = minmana;
    emxEnsureCapacity_real_T(&d_st, tau, i, &cc_emlrtRTEI);
    for (i = 0; i < minmana; i++) {
      tau->data[i] = 0.0;
    }
  } else {
  ...
  R->size[0] = minmana;
  R->size[1] = b_A->size[1];
  emxEnsureCapacity_real_T(&b_st, R, i, &dc_emlrtRTEI);
  ...
  for (na = ma; na <= n; na++) {
    ...
    for (i = 0; i < minmana; i++) {
      R->data[i + R->size[0] * (na - 1)] = b_A->data[i + b_A->size[0] * (na - 1)];
    }
  }
  ...
  if ((b_A->size[0] != 0) && (b_A->size[1] != 0)) {
    info_t = LAPACKE_dorgqr(102, (ptrdiff_t)b_A->size[0], (ptrdiff_t)minmana,
      (ptrdiff_t)minmana, &b_A->data[0], (ptrdiff_t)b_A->size[0], &tau->data[0]);
    na = (int32_T)info_t;
      ...
      if (!b_p) {
        if (na == -1010) {
          ...
          emlrtErrorWithMessageIdR2018a(&f_st, &j_emlrtRTEI,
            "Coder:toolbox:LAPACKCallErrorInfo",
            "Coder:toolbox:LAPACKCallErrorInfo", 5, 4, 14, b_fname, 12, na);
        }
      }
    } else {
      p = false;
    ...
    if (p) {
      ...
      b_A->size[0] = na;
      b_A->size[1] = ma;
      emxEnsureCapacity_real_T(&e_st, b_A, i, &fc_emlrtRTEI);
      na *= ma;
      for (i = 0; i < na; i++) {
        b_A->data[i] = rtNaN;
      }
  ...
  Q->size[0] = m;
  Q->size[1] = minmana;
  emxEnsureCapacity_real_T(&b_st, Q, i, &ec_emlrtRTEI);
