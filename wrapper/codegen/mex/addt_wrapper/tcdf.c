...
static emlrtRSInfo jg_emlrtRSI = { 44, /* lineNo */
  "tcdf",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\stats\\eml\\tcdf.m"/* pathName */
};

static emlrtRSInfo kg_emlrtRSI = { 46, /* lineNo */
  "tcdf",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\stats\\eml\\tcdf.m"/* pathName */
};
...
static emlrtBCInfo c_emlrtBCI = { -1,  /* iFirst */
  ...
  "",                                  /* aName */
  "tcdf",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\stats\\eml\\tcdf.m",/* pName */
  0                                    /* checkKind */
};
          ...
          real_T v, real_T p_data[], int32_T p_size[2])
{
  ...
  for (k = 0; k < i; k++) {
    ...
    if (1 > exponent) {
      emlrtDynamicBoundsCheckR2012b(1, 1, exponent, &c_emlrtBCI, sp);
    }

    if ((v > 0.0) && (!muDoubleScalarIsNaN(x_data[0]))) {
      if (x_data[0] == 0.0) {
        if (1 > i) {
          emlrtDynamicBoundsCheckR2012b(1, 1, i, &d_emlrtBCI, sp);
        }

        p_data[0] = 0.5;
      } else if (v > 1.0E+7) {
        if (1 > i) {
          emlrtDynamicBoundsCheckR2012b(1, 1, i, &e_emlrtBCI, sp);
        }
        ...
        if (muDoubleScalarIsNaN(x)) {
          ...
          xsq = (((absx - 1.0) * ((absx - 1.0) * ((absx - 1.0) * ((absx - 1.0) *
                     ((absx - 1.0) * ((absx - 1.0) * -0.0021663755948687908 +
            0.035478304325618236) + -0.11089469428239668) + 0.31834661990116175)
                    + -0.37220787603570132) + 0.41485611868374833) +
                  -0.0023621185607526594) / ((absx - 1.0) * ((absx - 1.0) *
                   ((absx - 1.0) * ((absx - 1.0) * ((absx - 1.0) * ((absx - 1.0)
            * 0.011984499846799107 + 0.013637083912029051) + 0.12617121980876164)
          ...
          if (absx < 2.8571414947509766) {
            ...
            S = xsq * (xsq * (xsq * (xsq * (xsq * (xsq * (xsq * (xsq *
          ...
          xsq = muDoubleScalarExp(-xsq * xsq - 0.5625) * muDoubleScalarExp((xsq
            - absx) * (xsq + absx) + R / S) / absx;
          if (x < 0.0) {
            xsq = 2.0 - xsq;
          }
        }
        ...
        if (1 > i) {
          emlrtDynamicBoundsCheckR2012b(1, 1, i, &f_emlrtBCI, sp);
        }
        ...
        if (x_data[0] > 0.0) {
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &g_emlrtBCI, sp);
          }
        ...
        if (v < xsq) {
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &h_emlrtBCI, sp);
          }
          ...
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &i_emlrtBCI, sp);
          }
        ...
        if (x_data[0] > 0.0) {
          if (1 > i) {
            emlrtDynamicBoundsCheckR2012b(1, 1, i, &j_emlrtBCI, sp);
          }
      ...
      if (1 > i) {
        emlrtDynamicBoundsCheckR2012b(1, 1, i, &k_emlrtBCI, sp);
      }
